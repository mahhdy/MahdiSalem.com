...
export const categories: Category[] = [
  ...
  },
  {
    ...
    nameFa: 'جامعه شناسی',
    nameEn: 'Sociology',
    descriptionFa: 'مطالعات مربوط به جامعه و مبانی آن',
    descriptionEn: 'Studies on sociology and its foundations',
    imagePath: '/images/categories/sociology.svg',
    parentCategory: 'science',
    contentTypes: ['articles', 'books', 'proposals', 'statements', 'multimedia', 'dialogues'],
  },
    {
    ...
    descriptionFa: 'مطالعات مربوط به فرهنگ و مبانی آن',
    descriptionEn: 'Studies on culture and its foundations',
    imagePath: '/images/categories/cultural-studies.svg',
    parentCategory: 'science',
    contentTypes: ['articles', 'books', 'proposals', 'statements', 'multimedia', 'dialogues'],
  },
  {
 ...
 */
export function getCategoriesByContentType(contentType: 'articles' | 'books' | 'proposals' | 'statements' | 'multimedia' | 'dialogues'): Category[] {
