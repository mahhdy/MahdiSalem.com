...
coverImage: /images/articles/covers/iran-crisis-to-growth-cover.webp
imageDisplay: full
cardImage: show
---
...
<nav className="toc" id="toc">
  <h2>📑 فهرست مطالب</h2>
  <details>
    <summary>نمایش/پنهان کردن</summary>
    <ol>
      <li><a href="#ch1">مقدمه و چارچوب نظری</a></li>
      <li><a href="#ch2">آرمان‌شهرها و یوتوپیاهای تصویرشده</a></li>
      <li><a href="#ch3">تحلیل چندبُعدی: دغدغه‌ها و زاویه‌ها</a></li>
      <li><a href="#ch4">حقوق بشر و ارزش‌های جهان‌شمول</a></li>
      <li><a href="#ch5">فردگرایی و اومانیسم</a></li>
      <li><a href="#ch6">حقوق کارگری و دولت رفاه: خطوط سیر تاریخی</a></li>
      <li><a href="#ch7">زیرگروه‌های چپ و راست و نظریه‌پردازان</a></li>
      <li><a href="#ch8">جنبش‌های بزرگ اجتماعی</a></li>
      <li><a href="#ch9">نتیجه‌گیری و ترکیب نهایی</a></li>
    </ol>
  <ol>
    <li>
...
timeline
    ...
    section "دورهٔ ۱ ۱۷۸۹–۱۸۴۸"
      سلطنت‌طلبان در برابر جمهوری‌خواهان : راست = اشراف و سلطنت ، چپ = ژاکوبن‌ها و جمهوری‌خواهان
    section "دورهٔ ۲ ۱۸۴۸–۱۹۱۷"
      مسألهٔ اجتماعی و طبقاتی : راست = بورژوازی لیبرال + محافظه‌کاران ، چپ = سوسیالیست‌ها و سندیکالیست‌ها
    section "دورهٔ ۳ ۱۹۱۷–۱۹۸۹"
      جنگ سرد ایدئولوژیک : راست = سرمایه‌داری لیبرال ، چپ = کمونیسم + سوسیال‌دموکراسی
    section "دورهٔ ۴ ۱۹۸۹–اکنون"
      جهانی‌شدن و بحران هویت : راست = نئولیبرالیسم + پوپولیسم ملی‌گرا ، چپ = چپ نو + عدالت اجتماعی + اکولوژی
```
...
```mermaid
timeline
    title "تایملاین کلی: از انقلاب صنعتی تا دولت رفاه مدرن"
    ...
    section "دورهٔ سازمان‌دهی ۱۸۸۰–۱۹۱۴"
      قوانین بیسمارک : بیمهٔ بیماری، حوادث و بازنشستگی
      رشد اتحادیه‌ها : TUC انگلستان، CGT فرانسه، AFL آمریکا
    section "دورهٔ بحران و جنگ ۱۹۱۴–۱۹۴۵"
      جنگ جهانی اول : حق رأی زنان و قوانین کار
      نیو دیل روزولت : تأمین اجتماعی ۱۹۳۵ و حداقل دستمزد ۱۹۳۸
      گزارش بوریج : طراحی دولت رفاه بریتانیا ۱۹۴۲
    section "عصر طلایی ۱۹۴۵–۱۹۷۵"
      دولت رفاه فراگیر : NHS بریتانیا، مدل نوردیک و سکوریته سوسیال
    section "واکنش نئولیبرال ۱۹۷۵–۲۰۰۸"
      تاچریسم و ریگانیسم : خصوصی‌سازی و کاهش اتحادیه‌ها
