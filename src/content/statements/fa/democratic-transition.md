...
## نسخه‌ی بازبینی‌شده و گسترش‌یافته
...
تجربه‌ی جهانی نشان داده است که **کیفیت فرایند گذار**، بیش از هر عامل دیگری، تعیین‌کننده‌ی کیفیت نظام سیاسی آینده است. از تونس تا آفریقای جنوبی، از اسپانیا تا لهستان، کشورهایی که گذار موفق‌تری را تجربه کرده‌اند، آن‌هایی بوده‌اند که با طراحی نهادی آگاهانه، فراگیر و مبتنی بر اجماع، از دام‌های هرج‌ومرج، بازگشت استبداد، یا جنگ داخلی گریخته‌اند.

---

## ۲. چارچوب گذار: مجلس مهستان

پیشنهاد اینجانب برای دوران گذار و اصلی‌ترین موضوع آن، یعنی ترتیبات نهادی گذار، به شرح زیر ارائه می‌شود.

**نهاد محوری گذار** یک **مجلس مردم‌محور منتخب** (مجلس مهستان) است که در اسرع وقت پس از آغاز دوره‌ی گذار تشکیل خواهد شد. آمادگی و طراحی زیرساخت‌های این انتخابات از هم‌اکنون باید آغاز شود تا در لحظه‌ی مقتضی به سرعت قابل‌ اجرا باشد.

### الف) فرایند انتخابات و تشکیل مجلس

**۱.** جریان‌ها و دسته‌هایی به شکل خودجوش باید شکل گرفته و برای عضویت در این نهاد ملی گذار، اعضایی را در کل کشور (یا منطقه‌ی مورد نظر خود) به شکل فهرست کاندیداهای مورد تأیید معرفی کنند.

**۲.** پس از آغاز دوره‌ی گذار، فرایند ثبت‌نام و تبلیغات رسمی‌تر آغاز می‌شود. با این وجود، تبلیغات و معرفی و ائتلاف‌ها از همین اکنون نیز قابل انجام و پیشبرد است. ثبت‌نام رسمی افراد و معرفی فهرست‌ها در وب‌سایت وزارت کشور و سایر وب‌سایت‌ها و نشریات داخلی و خارجی و سایر روش‌های انتشار عمومی منعکس خواهد شد. معرفی محله‌محور و محیطی نیز توسط خود کاندیداها و تشکیلات جریانی که پشتیبانی از آن‌ها را بر عهده دارد صورت می‌گیرد.

**۳.** شرایط مورد نیاز برای برگزاری رأی‌گیری و تبلیغات و ثبت‌نام به شکل غیرمتمرکز صورت خواهد گرفت. فرمانداری‌ها و شهرداری‌ها با کمک مدارس و آموزش‌وپرورش اجرای آن را بر عهده خواهند داشت. نظارت بر این فرایند از طریق معرفی ناظرانی از سوی جریان‌هایی که فهرست معرفی کرده‌اند تعیین می‌شود.

**۴.** انتخابات در زمان مقتضی صورت خواهد گرفت و پس از شمارش آرا و تأیید انتخابات، ظرف یک هفته مجلس مهستان دوران گذار تشکیل خواهد شد.

### ب) ساختار مجلس و هیأت رئیسه

**۵.** اگر جریانی که فهرست واحدی را در سراسر کشور معرفی کرده است به اکثریت مطلق برسد، ریاست مجلس را برای جلسه‌ی اول و تشکیل هیأت رئیسه بر عهده خواهد داشت. در غیر این صورت، ریاست سنی تعیین‌کننده‌ی ریاست موقت مجلس و مباشران آن خواهد بود.

**۶.** در صورت عدم رضایت مردمان منطقه از نماینده‌ی خود، در صورت وجود ۴۰٪ آرای مأخوذه برای شکایت و درخواست تغییر، نماینده عزل و نماینده‌ی بعدی در فهرست جایگزین خواهد شد.

**۷.** در صورت فوت و یا عدم توانایی مشارکت هر یک از نمایندگان منتخب، فرد بعدی در فهرست از همان ناحیه جایگزین خواهد شد.

**۸.** این مجلس نمی‌تواند بیش از دو سال ادامه داشته باشد و باید ۲ ماه قبل از اتمام دو سال، رأی‌گیری مجددی صورت گیرد.

### ج) تشکیل کابینه‌ی اجرایی موقت

**۹.** در صورت وجود جریان اکثریت، این جریان مسئول تشکیل کابینه‌ی اجرایی موقت خواهد شد. وظیفه‌ی این کابینه اجرای دستورات و تصمیم‌های مجلس و تهیه و تدوین طرح‌ها و لوایح مورد نیاز برای تصمیم‌گیری آن است.

**۱۰.** در صورت عدم وجود جریان اکثریت، ائتلافی از جریان‌ها و یا افراد مستقل به شکلی که به اکثریت قاطع برسند، تشکیل کابینه خواهند داد.

**۱۱.** در صورت عدم تشکیل هیچ ائتلافی، برای پست ریاست کابینه رأی‌گیری صورت گرفته و فردی که بالاترین رأی را بیاورد مسئول این‌ کار خواهد شد. در صورتی که کابینه نتواند ظرف یک هفته تشکیل شده یا رأی اعتماد بگیرد، افراد معرفی‌شده با بیشترین رأی به‌عنوان کاندیدای منتخب کابینه معرفی خواهند شد.

**۱۲.** کابینه به مجلس مهستان پاسخ‌گو است و اعضای کابینه باید به تأیید ۵۰٪+۱ نمایندگان آن برسند. استیضاح و درخواست تغییر اعضای کابینه و یا وتوی تصمیمات آن با رأی ۷۵٪ اعضای مجلس ممکن خواهد بود.

**۱۳.** بر حسب اقتضای شرایط، مجلس مهستان می‌تواند اختیارات تقنینی مشخصی را به کابینه‌ی اجرایی تفویض کند.

**۱۴.** وظایف و محدوده‌ی کاری و اجرایی کابینه‌ی موقت با نظر و تصمیم مجلس مهستان تعیین و مورد نظارت قرار می‌گیرد.

### د) دستگاه قضایی

**۱۵.** مجلس مهستان از میان اساتید رشته‌ی حقوق، کانون وکلا و یا قاضیان کشور، شورایی را برای رهبری دستگاه قضاییه انتخاب کرده و مأموریت‌هایی برای تصفیه، پاکسازی و سازمان‌دهی امور قضایی کشور به آن‌ها می‌سپارد. این شورا مسئول بازبینی و تهیه‌ی طرح‌هایی برای تعلیق برخی قوانین و تنظیم قوانین حقوقی-قضایی جدید خواهد بود.

### ه) نیروهای نظامی و انتظامی

**۱۶.** مجلس مهستان شورایی را برای مدیریت سیستم نظامی و انتظامی تعیین می‌کند و فردی را به سمت فرمانده‌ی موقت ستاد مشترک نیروهای نظامی و انتظامی به‌ کار می‌گمارد. رئیس کابینه فهرستی از افراد واجد شرایط را به مجلس معرفی کرده و از میان آن‌ها دو فرد (فرمانده و جانشین) مستقیماً توسط مجلس تعیین می‌شوند. هماهنگی‌های اجرایی با رئیس کابینه و دستورات و حدود اختیارات و برنامه‌های گسترده‌تر با تصویب مجلس اعتبار خواهد یافت.

### و) قانون‌گذاری و تدوین قانون اساسی

**۱۷.** مجلس به‌موازات به بررسی قوانین عمومی‌تر کشور پرداخته و طرح جرم سیاسی و عدالت انتقالی را در اسرع وقت تدوین خواهد کرد.

**۱۸.** مجلس گروهی را مأمور تهیه و تدوین پیش‌نویس قانون اساسی و تنظیمات نهادی مختلف آن خواهد کرد.

**۱۹.** نهاد کنونی مرکز تحقیقات مجلس با ریاست جدید، مسئولیت هماهنگی با متخصصان و جمع‌آوری نظرات تخصصی و نظرسنجی‌های عمومی را بر عهده خواهد گرفت.

### ز) رفراندوم و دموکراسی مستقیم

**۲۰.** تصمیم در خصوص رفراندوم‌های مختلف، زمان‌بندی و روش انجام آن‌ها و نوع همکاری بین‌المللی برای تأیید کیفیت دموکراتیک آن‌ها در مجلس مهستان اخذ خواهد شد.

**۲۱.** مجلس مهستان می‌تواند به فراخور نیاز، نظرسنجی‌های گسترده‌ای را از طریق بستر نرم‌افزاری و تأییدیه‌های کد ملی و پاسپورت‌های معتبر برای موضوعات مختلف انجام دهد و تلاش کند فرایند گذار به شکل دموکراسی مستقیم صورت پذیرد. مجلس موظف خواهد بود در این زمینه طرحی را از سوی مرکز تحقیقات آماده کرده و توسط کابینه اجرایی سازد.

> **بند ۳۲ (تکمیلی).** مجلس مهستان در اسرع وقت و حداکثر ظرف **۳ ماه** پس از تشکیل، **قانون عدالت انتقالی** را تصویب خواهد کرد. این قانون بر اساس یکی از مدل‌های شناخته‌شده‌ی بین‌المللی (مدل چهارستونی سازمان ملل، مدل پنج‌ستونی جامع، یا مدل ترکیبی) و با مشاوره‌ی عمومی، نظر متخصصان، و شنیدن صدای قربانیان تدوین خواهد شد. **انتخاب مدل نهایی با رأی اکثریت مجلس مهستان خواهد بود** و مردم ایران از طریق بستر دموکراسی مستقیم در این تصمیم‌گیری مشارکت خواهند داشت.
...
1. **مسالمت‌آمیز بودن**: خشونت سازمان‌یافته و نهادی‌شده پس از فروپاشی نظام راه‌حل نیست و تنها به تداوم چرخه‌ی استبداد منجر می‌شود. عدالت از طریق سازوکارهای قانونی اجرا خواهد شد.

2. **فراگیر بودن**: همه اقشار و گروه‌های اجتماعی، قومی، مذهبی، جنسیتی و سیاسی باید در فرایند گذار مشارکت داشته باشند. **«ایران برای همه‌ی ایرانیان»**.

3. **مبتنی بر حقوق بشر**: حقوق بنیادین همه شهروندان — از جمله آزادی بیان، آزادی تجمع، آزادی مذهب و عقیده، و حق مشارکت سیاسی — باید تضمین شود.

4. **عدالت انتقالی**: باید سازوکارهایی برای رسیدگی به جنایات گذشته، بازگرداندن حقوق تضییع‌شده، و ایجاد حافظه‌ی تاریخی وجود داشته باشد.

5. **حاکمیت قانون**: تمام تصمیمات دوران گذار باید در چارچوب قانونی شفاف و پاسخ‌گو اتخاذ شود.

6. **حفظ تمامیت ارضی و انسجام ملی**: با احترام به تنوع قومی و فرهنگی، تمامیت ارضی کشور حفظ و حقوق اقلیت‌ها تضمین خواهد شد.

7. **شفافیت و پاسخ‌گویی**: همه‌ی نهادهای دوران گذار موظف به شفافیت در عملکرد و پاسخ‌گویی به مردم خواهند بود.

---

## ۴. فراخوان

از همه‌ی ایرانیان آزادیخواه دعوت می‌کنیم تا در گفتگوی سازنده درباره‌ی آینده‌ی ایران مشارکت کنند. این بیانیه دعوتی است برای اندیشیدن، تکمیل، و چکش‌کاری این چارچوب در راستای اجرایی شدن هرچه سریع‌تر آن. جزئیات بیشتر در کتاب و طرح پیشنهادی ارائه خواهد شد.
...
## ضمیمه‌ی الف: تحلیل تطبیقی گذارهای دموکراتیک
...
## ضمیمه‌ی ح: نمودارهای ساختاری (Mermaid)
...
gantt
    ...
    section فاز 3 — قانون اساسی موقت
    ...
    section فاز 5 — قانون اساسی نهایی
...
gantt
    ...
    section ستون 2 — عدالت کیفری
    بازداشت عاملان اصلی (سطح 1)            :crit, j1, 2025-10-01, 90d
    تشکیل دادگاه‌های ویژه                  :j2, 2025-11-01, 120d
    آغاز بازجویی‌های رسمی                  :j3, 2026-01-01, 180d
    محاکمه‌ی فرماندهان عالی (سطح 1)        :crit, j4, 2026-06-01, 365d
    محاکمه‌ی فرماندهان میانی (سطح 2)       :j5, 2026-09-01, 365d
    برنامه‌ی عفو مشروط (سطح 3)             :j6, 2026-06-01, 300d
    فرایند lustration (سطح 4)               :j7, 2026-03-01, 365d

    section ستون 3 — جبران خسارت
