...
<title>آرمان‌شهرها و یوتوپیاهای چپ و راست سیاسی — تحقیق جامع</title>
...
<style>
  ...
  *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  :root {
    ...
    --table-alt:  #F0F4F8;
    --card-bg:    #FFFFFF;
    --card-shadow: 0 2px 16px rgba(15,52,96,0.08);
    --border:     #E2E8F0;
    --quote-bg:   #FFF8E7;
    --quote-border:#F5A623;
    --tag-left-bg:  rgba(231,76,60,0.10);
    --tag-right-bg: rgba(46,134,193,0.10);
    --gradient-head: linear-gradient(135deg, #0F3460 0%, #E94560 100%);
  }
  ...
  .toc {
    ...
    padding: 32px;
    margin-bottom: 48px;
    border-right: 5px solid var(--section);
  }
  .toc h2 {
    color: var(--section);
    font-size: 1.3rem;
  ...
  .toc a:hover { color: var(--chapter); }
  .toc .sub {
    padding-right: 44px;
    font-size: 0.9rem;
    color: var(--neutral);
  }
  .toc .sub li { margin-bottom: 4px; }
  ...
  .chapter-divider::before {
    ...
    left: 0; right: 0;
    height: 2px;
    background: linear-gradient(90deg, transparent, var(--chapter), transparent);
  }
  ...
  h2.chapter {
    ...
    margin-bottom: 8px;
    padding-bottom: 12px;
    border-bottom: 3px solid var(--chapter);
  ...
  h3.section {
    ...
    margin: 36px 0 12px;
    padding-right: 16px;
    border-right: 4px solid var(--section);
  }
  ...
  thead th:first-child { border-radius: 0 12px 0 0; }
  thead th:last-child  { border-radius: 12px 0 0 0; }
  tbody td {
    padding: 12px 16px;
  ...
  tbody tr:hover { background: rgba(245,166,35,0.07); }
  ...
  .card {
    ...
    padding: 28px;
    margin: 24px 0;
    border-top: 4px solid var(--section);
  }
  .card.left  { border-top-color: var(--left-color); }
  .card.right { border-top-color: var(--right-color); }
  ...
  .tag.left  { background: var(--tag-left-bg);  color: var(--left-color); }
  .tag.right { background: var(--tag-right-bg); color: var(--right-color); }
  .tag.neutral { background: #F0F0F0; color: var(--neutral); }
  .tag.accent  { background: rgba(245,166,35,0.15); color: #C88200; }

  /* ───────── COMPARISON GRID (ادامه) ───────── */
  ...
  .compare-grid .col.left-col  { border-top: 4px solid var(--left-color); }
  .compare-grid .col.right-col { border-top: 4px solid var(--right-color); }
  .compare-grid .col h4 { margin-bottom: 10px; }
  .compare-grid .col.left-col  h4 { color: var(--left-color); }
  .compare-grid .col.right-col h4 { color: var(--right-color); }
  ...
  .timeline::before {
    ...
    bottom: 0;
    width: 3px;
    background: linear-gradient(180deg, var(--right-color), var(--accent), var(--left-color));
    border-radius: 3px;
  }
  .timeline-item {
    position: relative;
  ...
  .timeline-item.left-event::before  { border-color: var(--left-color); background: var(--tag-left-bg); }
  .timeline-item.right-event::before { border-color: var(--right-color); background: var(--tag-right-bg); }
  .timeline-item.mixed-event::before { border-color: var(--accent); background: rgba(245,166,35,0.15); }
  .timeline-date {
    font-weight: 800;
    font-size: 0.95rem;
    color: var(--section);
  ...
  .ref-list h3 { color: var(--section); margin-bottom: 12px; }
  .ref-list ol { padding-right: 20px; }
  .ref-list li { margin-bottom: 6px; line-height: 1.7; }
  ...
  .badge.era { background: #EDE7F6; color: #5E35B1; }
  .badge.person { background: #E8F5E9; color: #2E7D32; }

  /* ───────── PRINT ───────── */
  @media print {
    .hero { padding: 30px; }
    .card, .table-wrapper, .mermaid-wrapper { break-inside: avoid; }
    body { font-size: 12px; }
  }
</style>
</head>
...
<!-- ╚══════════════════════════════════════════╝ -->
<header class="hero">
  <h1>آرمان‌شهرها و یوتوپیاهای چپ و راست سیاسی</h1>
  <p class="subtitle">
...
<div class="chapter-divider"><span>فصل اول</span></div>
<h2 class="chapter" id="ch1">۱. مقدمه و چارچوب نظری</h2>

<h3 class="section" id="s1-1">۱.۱ ریشه‌شناسی تاریخی دوگانهٔ چپ–راست</h3>
...
<div class="compare-grid">
  <div class="col right-col">
    ...
    <span class="tag right">محافظه‌کار</span>
    <span class="tag right">سلطنت‌طلب</span>
  </div>
  <div class="col left-col">
    ...
    <span class="tag left">انقلابی</span>
    <span class="tag left">جمهوری‌خواه</span>
  </div>
</div>
...
<!-- MERMAID: تحول تاریخی معنای چپ و راست -->
...
<p class="caption">نمودار ۱ – تحول تاریخی محتوای دوگانهٔ چپ–راست از ۱۷۸۹ تاکنون</p>
</div>


<h3 class="section" id="s1-2">۱.۲ مدل‌های چندبُعدی طیف سیاسی</h3>
...
<p class="caption">نمودار ۲ – جایگاه تقریبی نظریه‌پردازان در مدل دو محوری</p>
</div>
...
<h3 class="section" id="s1-3">۱.۳ آیا دوگانهٔ چپ–راست هنوز معتبر است؟</h3>
...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td><span class="tag accent">دفاع از اعتبار</span></td>
    ...
    <tr>
      ...
      <td><span class="tag neutral">تردید</span></td>
    ...
    <tr>
      ...
      <td><span class="tag neutral">تردید (با بازنگری بعدی)</span></td>
...
<!-- ╔══════════════════════════════════════════════════════════╗ -->
<!-- ║  فصل ۲: آرمان‌شهرها و یوتوپیاهای تصویرشده               ║ -->
<!-- ╚══════════════════════════════════════════════════════════╝ -->

<div class="chapter-divider"><span>فصل دوم</span></div>
<h2 class="chapter" id="ch2">۲. آرمان‌شهرها و یوتوپیاهای تصویرشده</h2>
...
<p class="caption">نمودار ۳ – نقشهٔ ذهنی آرمان‌شهرهای اصلی طیف سیاسی</p>
</div>


<h3 class="section" id="s2-1">۲.۱ یوتوپیاهای راست</h3>

<h4 class="subsection">محافظه‌کاری سنتی</h4>
...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td><span class="badge era">۱۷۹۰</span></td>
    ...
    <tr>
      ...
      <td><span class="badge era">۱۷۹۶</span></td>
    ...
    <tr>
      ...
      <td><span class="badge era">۱۹۶۲</span></td>
    ...
    <tr>
      ...
      <td><span class="badge era">۱۹۸۰</span></td>
...
<h4 class="subsection">لیبرالیسم کلاسیک و لیبرتارینیسم</h4>
...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td><span class="badge era">۱۶۸۹</span></td>
    ...
    <tr>
      ...
      <td><span class="badge era">۱۷۷۶</span></td>
    ...
    <tr>
      ...
      <td><span class="badge era">۱۹۴۴</span></td>
    ...
    <tr>
      ...
      <td><span class="badge era">۱۹۷۴</span></td>
    ...
    <tr>
      ...
      <td><span class="badge era">۱۹۵۷</span></td>
...
<h4 class="subsection">نئومحافظه‌کاری</h4>
...
<div class="card right">
  ...
  <p>
    <span class="badge person">ایروینگ کریستول</span>
    <span class="badge person">ویلیام کریستول</span>
    <span class="badge person">رابرت کیگان</span>
    <span class="badge person">لئو اشتراوس (الهام‌بخش فلسفی)</span>
  </p>
</div>


<h3 class="section" id="s2-2">۲.۲ یوتوپیاهای چپ</h3>

<h4 class="subsection">سوسیالیسم تخیلی</h4>
...
<h4 class="subsection">مارکسیسم</h4>
...
<!-- MERMAID: Flowchart منطق مارکسیسم -->
<div class="mermaid-wrapper">
<pre class="mermaid">
flowchart LR
...
<p class="caption">نمودار ۴ – منطق تاریخی مارکسیسم: از تضاد طبقاتی تا جامعهٔ بی‌طبقه</p>
</div>
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td><span class="badge era">۱۹۲۹–۱۹۳۵</span></td>
    ...
    <tr>
      ...
      <td><span class="badge era">۱۹۶۴</span></td>
...
<h4 class="subsection">سوسیال‌دموکراسی</h4>
...
<h4 class="subsection">آنارشیسم</h4>
...
<p class="caption">نمودار ۵ – شاخه‌های اصلی آنارشیسم و نمایندگان کلیدی</p>
</div>
...
<h3 class="section" id="s2-3">۲.۳ جدول تطبیقی بزرگ آرمان‌شهرها</h3>
...
<table>
  ...
  <tbody>
    ...
    <!-- ادامهٔ جدول تطبیقی بزرگ آرمان‌شهرها -->
    <tr>
...
<!-- MERMAID: نمودار رادار مقایسه‌ای -->
<div class="mermaid-wrapper">
<pre class="mermaid">
...
<p class="caption">نمودار ۶ – توزیع تقریبی اولویت ارزشی در یوتوپیای هر ایدئولوژی</p>
</div>


<!-- ╔══════════════════════════════════════════════════════════╗ -->
<!-- ║  فصل ۳: تحلیل چندبُعدی                                  ║ -->
<!-- ╚══════════════════════════════════════════════════════════╝ -->

<div class="chapter-divider"><span>فصل سوم</span></div>
<h2 class="chapter" id="ch3">۳. تحلیل چندبُعدی: دغدغه‌ها و زاویه‌ها</h2>
...
<p class="caption">نمودار ۷ – پنج محور بنیادین تمایز چپ و راست</p>
</div>


<!-- ═══════════════════ ۳.۱ محافظه‌کاری / پیشرفت‌گرایی ═══════════════════ -->
<h3 class="section" id="s3-1">۳.۱ محافظه‌کاری در برابر پیشرفت‌گرایی</h3>
...
<div class="compare-grid">
  <div class="col right-col">
    ...
    <span class="tag right">بِرک</span>
    <span class="tag right">اوکشات</span>
    <span class="tag right">اسکروتن</span>
    <span class="tag right">دو مِستر</span>
  </div>
  ...
  <div class="col left-col">
    ...
    <span class="tag left">روسو</span>
    <span class="tag left">مارکس</span>
    <span class="tag left">دیویی</span>
    <span class="tag left">کندورسه</span>
  </div>
</div>

<h4 class="subsection">پیچیدگی‌ها و استثناهای مهم</h4>
...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td><span class="tag right">راست محافظه‌کار</span></td>
      <td><span class="tag accent">اصلاح‌گر اجتماعی</span></td>
    ...
    <tr>
      ...
      <td><span class="tag left">چپ انقلابی</span></td>
      <td><span class="tag neutral">محافظه‌کار عملی</span></td>
      <td>«سوسیالیسم در یک کشور»، احیای ملی‌گرایی روسی، سلسله‌مراتب شدید حزبی</td>
    </tr>
    <tr>
      <td><strong>نئومحافظه‌کاران آمریکایی</strong></td>
      <td><span class="tag right">راست</span></td>
      <td><span class="tag accent">انقلابی در سیاست خارجی</span></td>
...
<!-- ═══════════════════ ۳.۲ انباشت / توزیع ═══════════════════ -->
<h3 class="section" id="s3-2">۳.۲ انباشت در برابر توزیع</h3>
...
<div class="compare-grid">
  <div class="col right-col">
    ...
    <span class="tag right">اسمیت</span>
    <span class="tag right">هایک</span>
    <span class="tag right">فریدمن</span>
    <span class="tag right">لَفِر</span>
  </div>
  ...
  <div class="col left-col">
    ...
    <span class="tag left">کینز</span>
    <span class="tag left">استیگلیتز</span>
    <span class="tag left">پیکتی</span>
    <span class="tag left">رالز</span>
  </div>
</div>

<h4 class="subsection">مقایسهٔ سیاست‌های عملی</h4>
...
<h4 class="subsection">شواهد تجربی: داده‌ها چه می‌گویند؟</h4>
...
<!-- MERMAID: نمودار تاریخی نابرابری -->
<div class="mermaid-wrapper">
<pre class="mermaid">
xychart-beta
...
<p class="caption">نمودار ۸ – روند U شکل نابرابری در آمریکا: کاهش در عصر نیو دیل و دولت رفاه، افزایش مجدد در عصر نئولیبرال (بر اساس داده‌های پیکتی و سائز)</p>
</div>


<!-- ═══════════════════ ۳.۳ دو مفهوم آزادی ═══════════════════ -->
<h3 class="section" id="s3-3">۳.۳ دو مفهوم آزادی (و یک سوم)</h3>
...
<p class="caption">نمودار ۹ – سه مفهوم بنیادین آزادی و لوازم هرکدام</p>
</div>
...
<div class="compare-grid">
  <div class="col right-col">
    ...
    <span class="tag right">لاک</span>
    <span class="tag right">هایک</span>
    <span class="tag right">نوزیک</span>
    <span class="tag right">برلین (بخشاً)</span>
  </div>
  ...
  <div class="col left-col">
    ...
    <span class="tag left">مارکس</span>
    <span class="tag left">سِن</span>
    <span class="tag left">رالز</span>
    <span class="tag left">نوسبام</span>
  </div>
</div>
...
<div class="card accent">
  ...
  <span class="tag accent">پتیت</span>
  <span class="tag accent">اسکینر</span>
  <span class="tag accent">ماکیاولی (سنت جمهوری‌خواهی)</span>
</div>

<h4 class="subsection">جدول تطبیقی سه مفهوم آزادی</h4>
...
<!-- ═══════════════════ ۳.۴ حمایت‌گرایی / مسئولیت شخصی ═══════════════════ -->
<h3 class="section" id="s3-4">۳.۴ حمایت‌گرایی در برابر مسئولیت شخصی</h3>
...
<h4 class="subsection">مواضع ترکیبی و میانه</h4>
...
<!-- ═══════════════════ ۳.۵ تبعیض و برابری ═══════════════════ -->
<h3 class="section" id="s3-5">۳.۵ تبعیض و برتری در برابر برابری و عدم تبعیض</h3>
...
<h4 class="subsection">نگرش‌های راست به برابری</h4>
...
<h4 class="subsection">نگرش‌های چپ به برابری</h4>
...
<h4 class="subsection">تایم‌لاین تاریخی مبارزه با تبعیض و سهم هر طیف</h4>

<div class="timeline">
  <div class="timeline-item mixed-event">
    <div class="timeline-date">۱۷۸۹</div>
    <div class="timeline-text">
      <strong>اعلامیهٔ حقوق بشر و شهروند</strong> (فرانسه) — 
      <span class="tag left">چپ انقلابی</span> <span class="tag right">لیبرال‌ها</span>
      <br>«انسان‌ها آزاد و برابر در حقوق زاده می‌شوند» — اما فقط مردان سفیدپوست مالک!
    </div>
  </div>

  <div class="timeline-item mixed-event">
    <div class="timeline-date">۱۸۳۳</div>
    <div class="timeline-text">
      <strong>لغو بردگی در امپراتوری بریتانیا</strong> — 
      <span class="tag right">لیبرال‌ها</span> <span class="tag neutral">اوانجلیست‌ها</span>
      <br>ائتلاف ویلیام ویلبرفورس (محافظه‌کار مذهبی) با لیبرال‌ها
    </div>
  </div>

  <div class="timeline-item left-event">
    <div class="timeline-date">۱۸۴۸</div>
    <div class="timeline-text">
      <strong>لغو بردگی در مستعمرات فرانسه</strong> — 
      <span class="tag left">جمهوری دوم</span>
      <br>به‌پیشنهاد ویکتور شولشر (چپ جمهوری‌خواه)
    </div>
  </div>

  <div class="timeline-item left-event">
    <div class="timeline-date">۱۸۹۳</div>
    <div class="timeline-text">
      <strong>حق رأی زنان در نیوزیلند</strong> — نخستین کشور جهان — 
      <span class="tag left">جنبش سافراژت</span>
    </div>
  </div>

  <div class="timeline-item mixed-event">
    <div class="timeline-date">۱۹۲۰</div>
    <div class="timeline-text">
      <strong>متمم ۱۹ قانون اساسی آمریکا: حق رأی زنان</strong> — 
      <span class="tag left">فمینیست‌ها</span> <span class="tag accent">پیشرفت‌گرایان هر دو حزب</span>
    </div>
  </div>

  <div class="timeline-item mixed-event">
    <div class="timeline-date">۱۹۴۸</div>
    <div class="timeline-text">
      <strong>اعلامیهٔ جهانی حقوق بشر</strong> — ائتلاف بین‌المللی
      <span class="tag left">سوسیالیست‌ها</span> 
      <span class="tag right">لیبرال‌ها</span> 
      <span class="tag neutral">مسیحی‌دموکرات‌ها</span>
    </div>
  </div>

  <div class="timeline-item left-event">
    <div class="timeline-date">۱۹۵۴–۱۹۶۸</div>
    <div class="timeline-text">
      <strong>جنبش حقوق مدنی آمریکا</strong> — 
      <span class="tag left">چپ</span> <span class="tag accent">لیبرال‌های میانه</span>
      <br>مارتین لوتر کینگ: ترکیب الهیات اجتماعی + سوسیال‌دموکراسی + مبارزهٔ غیرخشونت‌آمیز
    </div>
  </div>

  <div class="timeline-item left-event">
    <div class="timeline-date">۱۹۹۴</div>
    <div class="timeline-text">
      <strong>پایان آپارتاید در آفریقای جنوبی</strong> — 
      <span class="tag left">ANC</span> <span class="tag accent">فشار بین‌المللی چپ و لیبرال</span>
    </div>
  </div>

  <div class="timeline-item left-event">
    <div class="timeline-date">۲۰۱۵</div>
    <div class="timeline-text">
      <strong>قانونی شدن ازدواج همجنس‌گرایان در آمریکا</strong> — 
      <span class="tag left">چپ</span> <span class="tag accent">لیبرال‌ها</span>
      <br>مقاومت اصلی از سوی <span class="tag right">راست مذهبی</span>
    </div>
  </div>
</div>

<h4 class="subsection">خلاصهٔ چندبُعدی فصل ۳</h4>
...
<!-- ╔══════════════════════════════════════════════════════════╗ -->
<!-- ║  فصل ۴: حقوق بشر و ارزش‌های جهان‌شمول                    ║ -->
<!-- ╚══════════════════════════════════════════════════════════╝ -->

<div class="chapter-divider"><span>فصل چهارم</span></div>
<h2 class="chapter" id="ch4">۴. حقوق بشر و ارزش‌های جهان‌شمول</h2>

<h3 class="section" id="s4-1">۴.۱ سه نسل حقوق بشر و خاستگاه ایدئولوژیک</h3>
...
<p class="caption">نمودار ۱۰ – سه نسل حقوق بشر: از آزادی تا همبستگی</p>
</div>
...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td>مدنی و سیاسی</td>
      <td>آزادی</td>
      <td><span class="tag right">لیبرالیسم</span></td>
    ...
    <tr>
      ...
      <td>برابری</td>
      <td><span class="tag left">سوسیالیسم / سوسیال‌دموکراسی</span></td>
    ...
    <tr>
      ...
      <td>برادری</td>
      <td><span class="tag left">جنبش‌های ضداستعماری</span> <span class="tag accent">اکولوژیسم</span></td>
...
<h3 class="section" id="s4-2">۴.۲ اعلامیهٔ جهانی حقوق بشر ۱۹۴۸: ائتلاف ایدئولوژیک</h3>

<h4 class="subsection">بازیگران کلیدی و گرایش‌های فکری آنها</h4>
...
<h4 class="subsection">نقشهٔ تنش‌های ایدئولوژیک در تدوین</h4>
...
<p class="caption">نمودار ۱۱ – تنش‌های سه‌جانبه در تدوین اعلامیهٔ جهانی و نتیجهٔ ترکیبی</p>
</div>


<h3 class="section" id="s4-3">۴.۳ ارزیابی: کدام پررنگ‌تر بود؟</h3>

<div class="card accent">
  <h4>⚖️ حکم نهایی</h4>
  <p>حقوق بشر مدرن محصول <strong>ائتلاف ناهمگون</strong> سه سنت فکری است:</p>
  <ul>
    <li><strong>لیبرالیسم</strong> <span class="tag right">میانه–راست</span> 
    → <strong>بنیان حقوقی</strong> را گذاشت: زبان حقوق فردی، حکومت قانون، تفکیک قوا</li>
    <li><strong>سوسیالیسم</strong> <span class="tag left">چپ</span> 
    → <strong>محتوای اجتماعی</strong> را افزود: حق کار، آموزش، بهداشت، تأمین اجتماعی</li>
    <li><strong>جنبش‌های ضداستعماری و رهایی‌بخش</strong> <span class="tag accent">جهان سوم</span> 
...
<p class="caption">نمودار ۱۲ – سهم تقریبی سه سنت فکری در شکل‌گیری مجموعهٔ حقوق بشر مدرن</p>
</div>

<h4 class="subsection">مقایسهٔ تفصیلی نقش‌ها: پررنگ‌تر، تکمیل‌کننده، یا مقاومت‌کننده؟</h4>
...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td><span class="tag right">لیبرالیسم</span></td>
      <td><span class="tag left">چپ دموکراتیک</span></td>
      <td><span class="tag neutral">محافظه‌کاری مذهبی · چپ اقتدارگرا</span></td>
    </tr>
    <tr>
      <td><strong>حق رأی همگانی</strong></td>
      <td><span class="tag left">جنبش کارگری · سافراژت‌ها</span></td>
      <td><span class="tag right">لیبرال‌های مترقی</span></td>
      <td><span class="tag right">محافظه‌کاران سنتی</span></td>
    </tr>
    <tr>
      <td><strong>حق کار و تأمین اجتماعی</strong></td>
      <td><span class="tag left">سوسیالیسم · سندیکاها</span></td>
      <td><span class="tag right">محافظه‌کاران پدرسالار (بیسمارک)</span></td>
      <td><span class="tag right">لیبرتارین‌ها · نئولیبرال‌ها</span></td>
    </tr>
    <tr>
      <td><strong>لغو تبعیض نژادی</strong></td>
      <td><span class="tag left">چپ · جنبش‌های رهایی‌بخش</span></td>
      <td><span class="tag right">لیبرال‌ها</span></td>
      <td><span class="tag right">راست نژادپرست · استعمارطلبان</span></td>
    </tr>
    <tr>
      <td><strong>برابری جنسیتی</strong></td>
      <td><span class="tag left">فمینیسم (چپ و لیبرال)</span></td>
      <td><span class="tag accent">لیبرال‌فمینیسم</span></td>
      <td><span class="tag right">محافظه‌کاری سنتی · بنیادگرایی مذهبی</span></td>
    </tr>
    <tr>
      <td><strong>حقوق زیست‌محیطی</strong></td>
      <td><span class="tag left">اکولوژیسم · چپ نو</span></td>
      <td><span class="tag accent">محافظه‌کاری سبز (اقلیت)</span></td>
      <td><span class="tag right">نئولیبرالیسم · صنایع فسیلی</span></td>
    </tr>
    <tr>
      <td><strong>حق مالکیت خصوصی</strong></td>
      <td><span class="tag right">لیبرالیسم</span></td>
      <td><span class="tag left">سوسیال‌دموکراسی (با محدودیت‌ها)</span></td>
      <td><span class="tag left">مارکسیسم · آنارشیسم</span></td>
    </tr>
  </tbody>
</table>
</div>
...
<!-- ╔══════════════════════════════════════════════════════════╗ -->
<!-- ║  فصل ۵: فردگرایی و اومانیسم                              ║ -->
<!-- ╚══════════════════════════════════════════════════════════╝ -->

<div class="chapter-divider"><span>فصل پنجم</span></div>
<h2 class="chapter" id="ch5">۵. فردگرایی و اومانیسم</h2>
...
<p class="caption">نمودار ۱۳ – دو سنت فردگرایی/اومانیسم و ریشهٔ مشترک رنسانسی</p>
</div>


<h3 class="section" id="s5-1">۵.۱ فردگرایی لیبرال (بیشتر راست کلاسیک)</h3>
...
<h3 class="section" id="s5-2">۵.۲ اومانیسم سوسیالیستی (چپ)</h3>
...
<h3 class="section" id="s5-3">۵.۳ شکاف نظری و عملی</h3>
...
<p class="caption">نمودار ۱۴ – مدل‌های سوسیال‌دموکراتیک نوردیک بالاترین HDI را با پایین‌ترین نابرابری ترکیب کرده‌اند (UNDP, 2023)</p>
</div>


<!-- ╔══════════════════════════════════════════════════════════╗ -->
<!-- ║  فصل ۶: حقوق کارگری و دولت رفاه                         ║ -->
<!-- ╚══════════════════════════════════════════════════════════╝ -->

<div class="chapter-divider"><span>فصل ششم</span></div>
<h2 class="chapter" id="ch6">۶. حقوق کارگری، رفاه عمومی و دولت رفاه: خطوط سیر تاریخی</h2>
...
<p class="caption">نمودار ۱۵ – تایم‌لاین کلی تکامل حقوق کارگری و دولت رفاه از ۱۷۸۰ تا ۲۰۲۳</p>
</div>


<!-- ═══════════════════ ۶.۱ انگلستان ═══════════════════ -->
<h3 class="section" id="s6-1">۶.۱ انگلستان: از کارخانه‌های منچستر تا NHS</h3>

<h4 class="subsection">فاز ۱: انقلاب صنعتی و بحران اجتماعی (۱۷۸۰–۱۸۴۰)</h4>
...
<div class="card" style="border-top-color: #7D8A96;">
...
<h4 class="subsection">فاز ۲: نخستین اصلاحات (۱۸۳۳–۱۸۶۷)</h4>
...
<div class="timeline">
  <div class="timeline-item mixed-event">
    ...
    <div class="timeline-text">
      ...
      <strong>پیش‌برنده:</strong> <span class="tag accent">ائتلاف اوانجلیست‌ها + رادیکال‌ها</span><br>
      <strong>مقاومت‌کننده:</strong> <span class="tag right">لیبرال‌های لایسه‌فِر (مکتب منچستر)</span>
    </div>
  </div>
  <div class="timeline-item left-event">
    <div class="timeline-date">۱۸۳۸–۱۸۵۷</div>
    <div class="timeline-text">
      ...
      <strong>ماهیت:</strong> <span class="tag left">چپ دموکراتیک-کارگری</span><br>
      <strong>نتیجهٔ فوری:</strong> شکست — اما تمام مطالباتش تا ۱۹۱۸ محقق شد!
    </div>
  </div>
  <div class="timeline-item right-event">
    <div class="timeline-date">۱۸۶۷</div>
    <div class="timeline-text">
      <strong>قانون اصلاحات دوم <em>(Second Reform Act)</em></strong><br>
      گسترش حق رأی به بخشی از طبقهٔ کارگر شهری<br>
      <strong>اقدام‌کننده:</strong> <span class="tag right">دیزرائیلی (محافظه‌کار)</span> — 
      با انگیزهٔ جذب رأی کارگران و پیشدستی بر لیبرال‌ها!
    </div>
  </div>
</div>

<h4 class="subsection">فاز ۳: اصلاحات لیبرال و تولد حزب کارگر (۱۹۰۰–۱۹۱۴)</h4>

<div class="timeline">
  <div class="timeline-item left-event">
    <div class="timeline-date">۱۹۰۰</div>
    <div class="timeline-text">
      <strong>تأسیس کمیتهٔ نمایندگی کارگران</strong> (بعداً حزب کارگر)<br>
      ائتلاف اتحادیه‌ها + فابیان‌ها + سوسیالیست‌ها<br>
      <span class="tag left">چپ دموکراتیک</span>
    </div>
  </div>
  <div class="timeline-item mixed-event">
    <div class="timeline-date">۱۹۰۶–۱۹۱۴</div>
    <div class="timeline-text">
      ...
      <strong>پیش‌برنده:</strong> <span class="tag accent">لیبرال‌های اجتماعی (نیو لیبرالیسم)</span><br>
      <strong>فشار از پایین:</strong> <span class="tag left">حزب کارگر نوپا + اتحادیه‌ها</span><br>
      <strong>مقاومت:</strong> <span class="tag right">محافظه‌کاران + مجلس اعیان</span>
    </div>
  </div>
</div>
...
<h4 class="subsection">فاز ۴: گزارش بوریج و دولت رفاه (۱۹۴۲–۱۹۵۱)</h4>
...
<p class="caption">نمودار ۱۶ – پنج «غول بزرگ» بوریج و پاسخ‌های نهادی دولت رفاه بریتانیا</p>
</div>

<div class="timeline">
  <div class="timeline-item left-event">
    <div class="timeline-date">۱۹۴۵–۱۹۵۱</div>
    <div class="timeline-text">
      ...
      <strong>پیش‌برنده:</strong> <span class="tag left">حزب کارگر + اتحادیه‌ها</span><br>
      <strong>تکمیل‌کننده:</strong> <span class="tag accent">اجماع ملی پس از جنگ (محافظه‌کاران هم پذیرفتند)</span>
    </div>
  </div>
</div>

<h4 class="subsection">فاز ۵: واکنش تاچریستی (۱۹۷۹–۱۹۹۰)</h4>
...
<h4 class="subsection">فاز ۶: راه سوم بلر و پس از آن (۱۹۹۷–اکنون)</h4>

<div class="timeline">
  <div class="timeline-item mixed-event">
    <div class="timeline-date">۱۹۹۷–۲۰۰۷</div>
    <div class="timeline-text">
      ...
      <span class="tag accent">راه سوم</span>: ترکیب مسئولیت فردی + حمایت دولتی مشروط
    </div>
  </div>
  <div class="timeline-item right-event">
    <div class="timeline-date">۲۰۱۰–۲۰۱۹</div>
    <div class="timeline-text">
      ...
      <span class="tag right">محافظه‌کاران</span>: ریاضت ضروری برای «اصلاح دفاتر مالی»
    </div>
  </div>
</div>
...
<!-- ═══════════════════ ۶.۲ فرانسه ═══════════════════ -->
<h3 class="section" id="s6-2">۶.۲ فرانسه: از کمون پاریس تا سکوریته سوسیال</h3>

<div class="timeline">
  <div class="timeline-item left-event">
    <div class="timeline-date">۱۸۷۱</div>
    <div class="timeline-text">
      ...
      <span class="tag left">چپ انقلابی</span>
    </div>
  </div>
  <div class="timeline-item mixed-event">
    <div class="timeline-date">۱۸۸۴</div>
    <div class="timeline-text">
      <strong>قانون والدِک-روسو: آزادی اتحادیه‌ها</strong><br>
      <span class="tag left">جمهوری‌خواهان رادیکال</span>
    </div>
  </div>
  <div class="timeline-item left-event">
    <div class="timeline-date">۱۸۹۵</div>
    <div class="timeline-text">
      <strong>تأسیس CGT (کنفدراسیون عمومی کار)</strong><br>
      <span class="tag left">سندیکالیسم انقلابی</span>
    </div>
  </div>
  <div class="timeline-item left-event">
    <div class="timeline-date">۱۹۳۶</div>
    <div class="timeline-text">
      ...
      <strong>پیش‌برنده:</strong> <span class="tag left">ائتلاف سوسیالیست‌ها + کمونیست‌ها + رادیکال‌ها</span><br>
      <strong>فشار از پایین:</strong> اعتصاب عمومی ۲ میلیون کارگر
    </div>
  </div>
  <div class="timeline-item left-event">
    <div class="timeline-date">۱۹۴۵–۱۹۴۶</div>
    <div class="timeline-text">
      ...
      <strong>پیش‌برنده:</strong> <span class="tag left">CGT + حزب کمونیست + سوسیالیست‌ها</span><br>
      <strong>تکمیل‌کننده:</strong> <span class="tag accent">گلیست‌ها (دو گل) + MRP مسیحی‌دموکرات</span>
    </div>
  </div>
  <div class="timeline-item left-event">
    <div class="timeline-date">۱۹۶۸</div>
    <div class="timeline-text">
      ...
      <span class="tag left">چپ + جنبش دانشجویی</span>
    </div>
  </div>
  <div class="timeline-item left-event">
    <div class="timeline-date">۱۹۸۱–۱۹۸۳</div>
    <div class="timeline-text">
      ...
      <span class="tag left">حزب سوسیالیست</span>
    </div>
  </div>
  <div class="timeline-item left-event">
    <div class="timeline-date">۲۰۰۰</div>
    <div class="timeline-text">
      <strong>هفتهٔ ۳۵ ساعته (قانون اوبری)</strong><br>
      <span class="tag left">دولت ژوسپن (سوسیالیست)</span><br>
      <strong>مقاومت:</strong> <span class="tag right">کارفرمایان (MEDEF) + راست</span>
    </div>
  </div>
</div>
...
<!-- ═══════════════════ ۶.۳ آمریکا ═══════════════════ -->
<h3 class="section" id="s6-3">۶.۳ آمریکا: استثنای آمریکایی</h3>
...
<div class="timeline">
  ...
  <div class="timeline-item left-event">
    ...
    <div class="timeline-text">
      ...
      <strong>پیش‌برنده:</strong> <span class="tag left">اتحادیه‌ها (CIO) + چپ دموکرات</span><br>
      <strong>مقاومت:</strong> <span class="tag right">جمهوری‌خواهان محافظه‌کار + دادگاه عالی (ابتدا)</span>
    </div>
  </div>
  <div class="timeline-item left-event">
    <div class="timeline-date">۱۹۶۴–۱۹۶۵</div>
    <div class="timeline-text">
      ...
      <span class="tag left">دموکرات‌های لیبرال + جنبش حقوق مدنی</span>
    </div>
  </div>
  <div class="timeline-item right-event">
    <div class="timeline-date">۱۹۸۱–۱۹۸۹</div>
    <div class="timeline-text">
      ...
      <span class="tag right">نئولیبرالیسم + محافظه‌کاری مذهبی</span>
    </div>
  </div>
  <div class="timeline-item mixed-event">
    <div class="timeline-date">۲۰۱۰</div>
    <div class="timeline-text">
      <strong>قانون مراقبت مقرون‌به‌صرفه <em>(ACA / Obamacare)</em></strong><br>
      گسترش بیمهٔ سلامت به ~۲۰ میلیون نفر · اما نه بیمهٔ همگانی<br>
      <span class="tag left">دموکرات‌ها</span> · مقاومت شدید <span class="tag right">جمهوری‌خواهان</span>
    </div>
  </div>
</div>
...
<!-- ═══════════════════ ۶.۴ سوئد ═══════════════════ -->
<h3 class="section" id="s6-4">۶.۴ سوئد و مدل نوردیک: آرمان‌شهر سوسیال‌دموکراتیک؟</h3>
...
<p class="caption">نمودار ۱۷ – ارکان مدل «خانهٔ مردم» سوئد</p>
</div>
...
<!-- ═══════════════════ ۶.۵ بلژیک و آلمان ═══════════════════ -->
<h3 class="section" id="s6-5">۶.۵ بلژیک و آلمان: مدل بیسمارکی و ارکان‌گرایی</h3>

<h4 class="subsection">آلمان: زادگاه تأمین اجتماعی مدرن</h4>

<div class="timeline">
  <div class="timeline-item right-event">
    <div class="timeline-date">۱۸۸۳–۱۸۸۹</div>
    <div class="timeline-text">
      ...
      <strong>اقدام‌کننده:</strong> <span class="tag right">بیسمارک (محافظه‌کار)</span><br>
      <strong>انگیزه:</strong> مهار جنبش سوسیال‌دموکراسی — «اگر من رفاه ندهم، سوسیالیست‌ها انقلاب می‌کنند»<br>
      <strong>پارادوکس:</strong> اصلاحاتِ <span class="tag right">راست محافظه‌کار</span> تحت فشار <span class="tag left">چپ سوسیال‌دموکرات</span>
    </div>
  </div>
  <div class="timeline-item left-event">
    <div class="timeline-date">۱۹۱۸–۱۹۱۹</div>
    <div class="timeline-text">
      <strong>جمهوری وایمار</strong><br>
      روز کار ۸ ساعته · حق رأی زنان · حقوق اجتماعی در قانون اساسی · شوراهای کارگری<br>
      <span class="tag left">SPD سوسیال‌دموکرات</span>
    </div>
  </div>
  <div class="timeline-item mixed-event">
    <div class="timeline-date">۱۹۴۹–۱۹۶۶</div>
    <div class="timeline-text">
      ...
      <strong>طراح:</strong> <span class="tag right">لودویگ ارهارد (CDU)</span><br>
      <strong>اما با فشار و همکاری:</strong> <span class="tag left">SPD + اتحادیه‌های قوی (DGB)</span>
    </div>
  </div>
</div>

<h4 class="subsection">بلژیک: ارکان‌گرایی و سازش اجتماعی</h4>
...
<!-- ═══════════════════ ۶.۶ تحلیل تطبیقی ═══════════════════ -->
<h3 class="section" id="s6-6">۶.۶ تحلیل تطبیقی: سهم هر نیروی ایدئولوژیک</h3>
...
<p class="caption">نمودار ۱۸ – دینامیزم کلی شکل‌گیری دولت رفاه: فشار چپ → واکنش میانه → مقاومت راست → نتیجهٔ نهایی</p>
</div>

<div class="insight">
  <h4>حکم تاریخی فصل ۶</h4>
    <!-- ادامهٔ حکم تاریخی فصل ۶ -->
    <p>
...
<p class="caption">نمودار ۱۹ – هزینهٔ عمومی اجتماعی بر حسب درصد GDP: فرانسه و بلژیک بالاترین، آمریکا و بریتانیا پایین‌ترین (OECD Social Expenditure Database, 2022)</p>
</div>


<!-- ╔══════════════════════════════════════════════════════════╗ -->
<!-- ║  فصل ۷: زیرگروه‌های چپ و راست                            ║ -->
<!-- ╚══════════════════════════════════════════════════════════╝ -->

<div class="chapter-divider"><span>فصل هفتم</span></div>
<h2 class="chapter" id="ch7">۷. زیرگروه‌های چپ و راست و نظریه‌پردازان</h2>

<h3 class="section" id="s7-1">۷.۱ زیرگروه‌های راست</h3>

<!-- MERMAID: شاخه‌های راست -->
<div class="mermaid-wrapper">
<pre class="mermaid">
flowchart TB
...
<p class="caption">نمودار ۲۰ – زیرگروه‌های اصلی طیف راست و نمایندگان کلیدی</p>
</div>
...
<h3 class="section" id="s7-2">۷.۲ زیرگروه‌های چپ</h3>
...
<p class="caption">نمودار ۲۱ – زیرگروه‌های اصلی طیف چپ و نمایندگان کلیدی</p>
</div>
...
<h3 class="section" id="s7-3">۷.۳ جداول شناسنامه‌ای نظریه‌پردازان کلیدی</h3>

<h4 class="subsection">نظریه‌پردازان کلیدی راست</h4>
...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td>۱۷۲۹–۱۷۹۷</td>
      <td><span class="tag right">محافظه‌کاری</span></td>
    ...
    <tr>
      ...
      <td>۱۷۲۳–۱۷۹۰</td>
      <td><span class="tag right">لیبرالیسم کلاسیک</span></td>
    ...
    <tr>
      ...
      <td>۱۸۹۹–۱۹۹۲</td>
      <td><span class="tag right">نئولیبرالیسم</span></td>
    ...
    <tr>
      ...
      <td>۱۹۱۲–۲۰۰۶</td>
      <td><span class="tag right">نئولیبرالیسم / مکتب شیکاگو</span></td>
    ...
    <tr>
      <td><strong>رابرت نوزیک</strong></td>
      <td>۱۹۳۸–۲۰۰۲</td>
      <td><span class="tag right">لیبرتارینیسم</span></td>
      <td><em>آنارشی، دولت و یوتوپیا</em> (۱۹۷۴)</td>
    ...
    <tr>
      ...
      <td>۱۹۲۵–۲۰۱۳</td>
      <td><span class="tag right">نئولیبرالیسم عملی</span></td>
...
<h4 class="subsection">نظریه‌پردازان کلیدی چپ</h4>
...
<table>
  ...
  <tbody>
    <tr>
      <td><strong>کارل مارکس</strong></td>
      <td>۱۸۱۸–۱۸۸۳</td>
      <td><span class="tag left">مارکسیسم</span></td>
    ...
    <tr>
      <td><strong>ادوارد برنشتاین</strong></td>
      <td>۱۸۵۰–۱۹۳۲</td>
      <td><span class="tag left">سوسیال‌دموکراسی</span></td>
    ...
    <tr>
      <td><strong>آنتونیو گرامشی</strong></td>
      <td>۱۸۹۱–۱۹۳۷</td>
      <td><span class="tag left">مارکسیسم نو</span></td>
      <td><em>دفترهای زندان</em></td>
    ...
    <tr>
      <td><strong>هربرت مارکوزه</strong></td>
      <td>۱۸۹۸–۱۹۷۹</td>
      <td><span class="tag left">چپ نو / فرانکفورت</span></td>
    ...
    <tr>
      <td><strong>جان رالز</strong></td>
      <td>۱۹۲۱–۲۰۰۲</td>
      <td><span class="tag left">لیبرالیسم اجتماعی / سوسیال‌دموکراسی فلسفی</span></td>
    ...
    <tr>
      ...
      <td>۱۹۰۸–۱۹۸۶</td>
      <td><span class="tag left">فمینیسم سوسیالیستی / اگزیستانسیالیسم</span></td>
    ...
    <tr>
      ...
      <td>۱۹۷۱–</td>
      <td><span class="tag left">سوسیال‌دموکراسی / نئومارکسیسم تحلیلی</span></td>
...
<!-- ╔══════════════════════════════════════════════════════════╗ -->
<!-- ║  فصل ۸: جنبش‌های بزرگ اجتماعی                           ║ -->
<!-- ╚══════════════════════════════════════════════════════════╝ -->

<div class="chapter-divider"><span>فصل هشتم</span></div>
<h2 class="chapter" id="ch8">۸. جنبش‌های بزرگ اجتماعی و ریشه‌های ایدئولوژیک</h2>

<h3 class="section" id="s8-1">۸.۱ مه ۱۹۶۸: «زیر سنگ‌فرش، ساحل است»</h3>
...
<!-- MERMAID: ریشه‌های ایدئولوژیک مه ۶۸ -->
<div class="mermaid-wrapper">
<pre class="mermaid">
flowchart TB
...
<p class="caption">نمودار ۲۲ – ریشه‌های ایدئولوژیک چندلایهٔ جنبش مه ۱۹۶۸</p>
</div>
...
<h3 class="section" id="s8-2">۸.۲ جنبش حقوق مدنی آمریکا (۱۹۵۴–۱۹۶۸)</h3>
...
<h3 class="section" id="s8-3">۸.۳ سایر جنبش‌های بزرگ</h3>
...
<div class="chapter-divider"><span>فصل نهم</span></div>
<h2 class="chapter" id="ch9">۹. نتیجه‌گیری و ترکیب نهایی</h2>

<h3 class="section">۹.۱ خلاصهٔ اجرایی</h3>
...
<h3 class="section">۹.۲ ماتریس نهایی</h3>

<!-- MERMAID: ماتریس نهایی -->
<div class="mermaid-wrapper">
<pre class="mermaid">
flowchart TB
...
<p class="caption">نمودار ۲۳ – ارزیابی نهایی: کدام طیف در کدام حوزه نقش پررنگ‌تری داشت</p>
</div>


<h3 class="section">۹.۳ چشم‌انداز آینده</h3>
...
<div class="chapter-divider"><span>پیوست‌ها</span></div>

<h3 class="section">پیوست الف: واژه‌نامهٔ تخصصی</h3>
...
<h3 class="section">پیوست ب: کتاب‌شناسی تفصیلی (منابع اصلی)</h3>
...
<h3 class="section">پیوست ج: فهرست نمودارها</h3>
...
<h3 class="section">پیوست د: نمایهٔ اَعلام (شخصیت‌های کلیدی)</h3>
...
<table>
  ...
  <tbody>
    <tr><td>آدام اسمیت</td><td><span class="tag right">راست</span></td><td>۱، ۲، ۳، ۷</td></tr>
    <tr><td>آمارتیا سِن</td><td><span class="tag left">چپ‌میانه</span></td><td>۳، ۵</td></tr>
    <tr><td>آنتونیو گرامشی</td><td><span class="tag left">چپ</span></td><td>۲، ۷، ۸</td></tr>
    <tr><td>آین رند</td><td><span class="tag right">راست</span></td><td>۲، ۵، ۷</td></tr>
    <tr><td>ادموند بِرک</td><td><span class="tag right">راست</span></td><td>۱، ۲، ۳، ۷</td></tr>
    <tr><td>ادوارد برنشتاین</td><td><span class="tag left">چپ</span></td><td>۲، ۷</td></tr>
    <tr><td>النور روزولت</td><td><span class="tag left">چپ‌میانه</span></td><td>۴</td></tr>
    <tr><td>اولوف پالمه</td><td><span class="tag left">چپ</span></td><td>۲، ۶</td></tr>
    <tr><td>توما پیکتی</td><td><span class="tag left">چپ</span></td><td>۳، ۷</td></tr>
    <tr><td>جان رالز</td><td><span class="tag left">چپ‌میانه</span></td><td>۲، ۳، ۵، ۷</td></tr>
    <tr><td>جان لاک</td><td><span class="tag right">راست</span></td><td>۱، ۲، ۳، ۴، ۵</td></tr>
    <tr><td>رابرت نوزیک</td><td><span class="tag right">راست</span></td><td>۲، ۳، ۵، ۷</td></tr>
    <tr><td>سیمون دو بوار</td><td><span class="tag left">چپ</span></td><td>۷، ۸</td></tr>
    <tr><td>فردریش هایک</td><td><span class="tag right">راست</span></td><td>۲، ۳، ۷</td></tr>
    <tr><td>فیلیپ پتیت</td><td><span class="tag accent">میانه</span></td><td>۳</td></tr>
    <tr><td>کارل مارکس</td><td><span class="tag left">چپ</span></td><td>۱، ۲، ۳، ۴، ۵، ۷</td></tr>
    <tr><td>مارتین لوتر کینگ</td><td><span class="tag left">چپ</span></td><td>۳، ۸</td></tr>
    <tr><td>مارگارت تاچر</td><td><span class="tag right">راست</span></td><td>۶، ۷</td></tr>
    <tr><td>میلتون فریدمن</td><td><span class="tag right">راست</span></td><td>۲، ۳، ۷</td></tr>
    <tr><td>نوربرتو بوبیو</td><td><span class="tag accent">میانه</span></td><td>۱، ۳</td></tr>
    <tr><td>هربرت مارکوزه</td><td><span class="tag left">چپ</span></td><td>۲، ۵، ۷، ۸</td></tr>
    <tr><td>ویلیام بوریج</td><td><span class="tag accent">میانه</span></td><td>۶</td></tr>
  </tbody>
</table>
</div>
