...
<summary class="no-print"> 📖 فهرست مطالب (برای کلیک) 
- [بخش یکم: نگاه از بالا — نقشه‌ی شماتیک آزادی](#sec1)
  - [خط زمانی ۲۵۰۰ ساله](#sec1-1)
  - [نقشه‌ی مفهومی مکاتب](#sec1-2)
  - [خانواده‌های مفهومی آزادی](#sec1-3)
  - [ماتریس متفکران و ابعاد](#sec1-4)
  - [نقشه‌ی دشمنان مفهومی](#sec1-5)
- [بخش دوم: هفت موج تحول](#sec2)
- [بخش سوم: آزادی در میان مکاتب و سنت‌های فکری](#sec3)
- [بخش چهارم: تحلیل تفصیلی تعبیرسازی‌ها](#sec4)
- [بخش پنجم: مفاهیم مجاور و مکمل](#sec5)
- [بخش ششم: جدول آثار اصلی نظریه‌پردازان](#sec6)
- [پیوست الف: آزادی در سنت اسلامی–ایرانی](#appA)
- [پیوست ب: نکات تحلیلی تکمیلی](#appB)
- [کتاب‌شناسی و منابع](#bib)
 

<section id="sec1">
<h2 class="section-title"><span class="num">۱</span> نگاه از بالا — نقشه‌ی شماتیک آزادی</h2>
...
<div class="diagram-wrapper">
  <p><strong>خط زمانی تحول مفهوم آزادی از یونان باستان  تا عصر مدرن اولیه</strong></p>
...
```
  ...
  <figcaption>شکل ۱ (بخش اول)–۱: خط زمانی ۲۵۰۰ ساله‌ی تحول تعبیرسازی از آزادی. هر نقطه نمایان‌گر لحظه‌ای کلیدی در بازتعریف مفهوم آزادی است.</figcaption>
</div>

<div class="diagram-wrapper">
  <p><strong>خط زمانی تحول مفهوم آزادی از مدرن اولیه تا کنون (عصر دیجیتال)</strong></p>
...
```
  ...
  <figcaption>شکل ۱ (بخش دوم) –۱: خط زمانی ۲۵۰۰ ساله‌ی تحول تعبیرسازی از آزادی. هر نقطه نمایان‌گر لحظه‌ای کلیدی در بازتعریف مفهوم آزادی است.</figcaption>
</div>
&#123;/* ─── 1.2 Mind Map of Schools ─── */&#125;
<h3 id="sec1-2">۱.۲ نقشه‌ی مفهومی مکاتب</h3>

<div class="diagram-wrapper">
  <p><strong>نقشه‌ی ذهنی: خانواده‌های فکری تعبیرسازی از آزادی</strong></p>
...
```
  ...
  <figcaption>شکل ۱–۲: نقشه‌ی ذهنی مکاتب اصلی تعبیرسازی از آزادی. هر شاخه یک &laquo;خانواده‌ی مفهومی&raquo; را نمایش می‌دهد.</figcaption>
</div>

<h3 id="sec1-3">۱.۳ خانواده‌های مفهومی آزادی</h3>

<div class="diagram-wrapper">
  <p><strong>طبقه‌بندی خانوادگی: سه تعبیر بنیادین و شاخه‌های فرعی</strong></p>
...
```
  ...
  <figcaption>شکل ۱–۳: طبقه‌بندی خانوادگی تعابیر آزادی. سه تعبیر بنیادین (منفی، مثبت، جمهوری‌خواهانه) در مرکز قرار دارند.</figcaption>
</div>
...
<p> هر تعبیر از آزادی در تقابل با یک &laquo;دشمن مفهومی&raquo; شکل گرفته است. نقشه‌ی زیر نشان می‌دهد که هر تعبیر چه چیزی را <em>نفی</em> می‌کند. </p>

<div class="diagram-wrapper">
  <p><strong>نقشه‌ی دشمنان مفهومی: هر تعبیر آزادی چه چیزی را نفی می‌کند؟</strong></p>
...
```
  ...
  <figcaption>شکل ۱–۵: هر تعبیر از آزادی، &laquo;دشمن&raquo; خاص خود را دارد. شناخت این دشمنان برای فهم دقیق هر نظریه ضروری است.</figcaption>
</div>
...
<div class="card accent-right">
  ...
  <p> &#128218; MacCallum, G. (1967). "Negative and Positive Freedom." <em>Philosophical Review</em>, 76(3), 312–334. </p>
</div>
...
<div class="diagram-wrapper">
  <p><strong>نمای کلی: هفت موج و جریان تحول</strong></p>
...
<div class="diagram-wrapper">
  <p><strong>نمودار هفت موج تحول مفهوم آزادی</strong></p>
...
```
  ...
  <figcaption>شکل ۲–۱:  (با تفصیل) هفت موج تحول مفهوم آزادی و زمینه‌های تاریخی هر موج</figcaption>
</div>
<div class="wave-card" id="wave1">
  <div class="wave-num">۱</div>
  <h3>موج اول: از بردگی تا شهروندی <span class="badge badge-blue">یونان و روم باستان &#8226; ۵۰۰ ق.م–۳۰۰ م</span></h3>

  <h4>&#128204; زمینه‌ی تاریخی</h4>
  <p> در یونان باستان، آزادی (<em>eleutheria</em>) پیش از آنکه مفهومی فلسفی باشد، <strong>وضعیتی اجتماعی–حقوقی</strong> بود: آزاد کسی بود که برده نبود. جنگ‌های ایران و یونان (۴۹۰–۴۷۹ ق.م) نخستین بار تمایز &laquo;آزاد/بنده&raquo; را به سطح گفتمان سیاسی آورد. هرودوت یونانیان را &laquo;آزاد&raquo; و ایرانیان را &laquo;بندگان شاه&raquo; خواند—تقابلی که بیش از واقعیت، ابزار هویت‌سازی بود (ر.ک. <a href="#appA">پیوست الف</a> برای نقد این روایت از منظر ایرانشهری). </p>
...
<div class="wave-card" id="wave2">
  ...
  <h3>موج دوم: اختیار و اراده <span class="badge badge-purple">قرون وسطی &#8226; ۴۰۰–۱۴۰۰ م</span></h3>
  ...
  <table>
    ...
    <tbody>
      ...
      <tr><td>غزالی</td><td>اسلامی–عرفانی</td><td>آزادی = بندگی خدا</td><td>آزادی حقیقی رهایی از بندگی نَفس و سلوک به‌سوی خداست</td></tr>
      <tr><td>مولانا</td><td>عرفان اسلامی</td><td>رهایی روح</td><td>&laquo;من بنده‌ی آنم که آزادی دهد&raquo;—رهایی در فنای فی‌الله</td></tr>
    </tbody>
  </table>
...
<div class="wave-card" id="wave3">
  ...
  <h3>موج سوم: حقوق طبیعی و قرارداد اجتماعی <span class="badge badge-gold">مدرن اولیه &#8226; ۱۵۰۰–۱۷۸۹</span></h3>
  ...
  <div class="diagram-wrapper">
    <p><strong>جریان تأثیر و تأثر در موج سوم</strong></p>
...
```
    ...
    <figcaption>شکل ۲–۲: شبکه‌ی تأثیر و تأثر متفکران موج سوم و پیوند آن‌ها با انقلاب‌های بزرگ</figcaption>
  </div>
  ...
  <div class="card accent-gold">
    ...
    <strong>نقد:</strong> روسو و کانت آزادی را &laquo;اخلاقی&raquo; کردند و راه را برای سوءاستفاده‌ی احتمالی باز کردند: اگر &laquo;آزادی واقعی = اطاعت از اراده‌ی عمومی&raquo;، می‌توان کسی را &laquo;مجبور به آزاد بودن&raquo; کرد — هشداری که برلین دو قرن بعد جدی گرفت.
  </div>
</div>

<div class="wave-card" id="wave4">
  <div class="wave-num">۴</div>
  <h3>موج چهارم: فردیت و رهایی <span class="badge badge-red">قرن نوزدهم &#8226; ۱۸۰۰–۱۹۰۰</span></h3>

  <h4>&#128204; زمینه‌ی تاریخی</h4>
  <p> انقلاب صنعتی، ظهور طبقه‌ی کارگر، شهرنشینی انبوه، و استعمار اروپایی بافت جدیدی به مسئله‌ی آزادی بخشید. از یک سو، <strong>لیبرال‌ها</strong> (میل، کنستان، توکویل) نگران سلطه‌ی اکثریت و دولت بر فرد بودند؛ از سوی دیگر، <strong>سوسیالیست‌ها</strong> (مارکس، انگلس) آزادی صوری لیبرالی را &laquo;بورژوایی&raquo; و فریبکارانه می‌دانستند. بنیامین کنستان (۱۸۱۹) نخستین بار تمایز &laquo;آزادی قدما&raquo; (مشارکت سیاسی) و &laquo;آزادی متأخران&raquo; (عدم مداخله) را صورت‌بندی کرد. </p>
  ...
  <div class="diagram-wrapper">
    <p><strong>دوگانه‌ی بزرگ قرن نوزدهم: فرد در برابر ساختار</strong></p>
...
```
    ...
    <figcaption>شکل ۲–۳: تقابل بنیادین قرن نوزدهم: آزادی فردی (لیبرال) در مقابل رهایی ساختاری (چپ) و تلاش ایدآلیست‌ها برای تلفیق</figcaption>
  </div>
...
<div class="wave-card" id="wave5">
  ...
  <h3>موج پنجم: آزادی منفی در برابر مثبت <span class="badge badge-green">اواسط قرن بیستم &#8226; ۱۹۴۰–۱۹۷۰</span></h3>

  <h4>&#128204; زمینه‌ی تاریخی</h4>
  <p> جنگ جهانی دوم، ظهور توتالیتاریسم (فاشیسم و استالینیسم)، و آغاز جنگ سرد بحران عمیقی در اندیشه‌ی آزادی ایجاد کرد. چگونه ایدئولوژی‌هایی که مدعی &laquo;آزادی واقعی&raquo; بودند (مارکسیسم-لنینیسم، فاشیسم)، به بدترین اشکال بردگی انجامیدند؟ <strong>آیزایا برلین</strong> در سخنرانی مشهور خود (۱۹۵۸) پاسخی تأثیرگذار داد. </p>
  ...
  <table>
    ...
    <tbody>
      ...
      <tr><td>سارتر (۱۹۴۳)</td><td>انتخاب وجودی</td><td><em>هستی و نیستی</em></td><td>&laquo;انسان محکوم به آزادی است&raquo;—آزادی ذات آگاهی است، نه حقی اعطاشده.</td></tr>
  ...
  <div class="diagram-wrapper">
    <p><strong>دوگانه‌ی برلین و واکنش‌ها</strong></p>
...
```
    ...
    <figcaption>شکل ۲–۴: تمایز برلین بین آزادی منفی و مثبت و شبکه‌ی واکنش‌ها</figcaption>
  </div>
...
<div class="wave-card" id="wave6">
  ...
  <h3>موج ششم: توانمندی، شناسایی، عدم سلطه <span class="badge badge-blue">اواخر قرن بیستم &#8226; ۱۹۷۰–۲۰۰۰</span></h3>

  <h4>&#128204; زمینه‌ی تاریخی</h4>
  <p> جنبش‌های حقوق مدنی، فمینیسم، ضداستعمار، و فروپاشی شوروی نشان دادند که نه &laquo;عدم مداخله&raquo; و نه &laquo;خودحکمرانی&raquo; به‌تنهایی کافی نیست. گروه‌هایی که رسماً آزاد بودند، عملاً از <em>سلطه</em>، <em>تحقیر</em>، و <em>محرومیت از توانمندی‌ها</em> رنج می‌بردند. سه رویکرد جدید ظاهر شد. </p>
  ...
  <div class="diagram-wrapper">
    <p><strong>سه شاخه‌ی نوظهور و نسبت آن‌ها با دوگانه‌ی برلین</strong></p>
...
```
    ...
    <figcaption>شکل ۲–۵: سه رویکرد نوظهور و مسیر به‌سوی تلفیق معاصر</figcaption>
  </div>
...
<div class="wave-card" id="wave7">
  ...
  <div class="diagram-wrapper">
    <p><strong>پنج مرز نوظهور آزادی در قرن ۲۱</strong></p>
...
```
    ...
    <figcaption>شکل ۲–۶: پنج مرز نوظهور بازاندیشی آزادی و پرسش مشترک: آیا چارچوب‌های موجود کفایت می‌کنند؟</figcaption>
  </div>
</div>
...
<div class="diagram-wrapper">
  <p><strong>طیف سیاسی و تعبیرهای رقیب آزادی</strong></p>
...
```
  ...
  <figcaption>شکل ۳–۱: پنج موضع سیاسی اصلی و تعبیر هر یک از آزادی</figcaption>
</div>
...
<div class="card accent-primary">
  ...
  <p><strong>&#10067; نقد اصلی (از چپ و میانه):</strong> آزادیِ صوری بدون منابع مادی بی‌معناست. فقیری که &laquo;آزاد&raquo; است ولی نان ندارد، واقعاً آزاد نیست. نوزیک حتی با بردگی داوطلبانه مشکلی ندارد—نقدی که سن و نوسبام مطرح کردند. </p>
</div>
...
<div class="card accent-right">
  ...
  <ul>
    ...
    <li><strong>هربرت مارکوزه</strong> (<em>انسان تک‌ساحتی</em>, 1964): جامعه‌ی مصرفی سرمایه‌داری آزادیِ ظاهری می‌دهد ولی نیازهای کاذب تولید می‌کند—&laquo;سرکوب مازاد&raquo;.</li>
  </ul>
  ...
  <p><strong>&#10067; نقد (از لیبرال‌ها):</strong> تجربه‌ی تاریخی نشان داد که لغو مالکیت خصوصی بدون نهادهای دموکراتیک، به توتالیتاریسم می‌انجامد. برلین دقیقاً همین را هشدار داد: آزادی &laquo;مثبت&raquo; مارکسیستی مستعد سوءاستفاده است. </p>
</div>
...
<div class="card accent-green">
  ...
  <p><strong>&#10067; نقد (از راست):</strong> دولت رفاه خود به سلطه‌ی بوروکراتیک و وابستگی می‌انجامد. هایک: &laquo;دولت رفاه راهِ بردگی است.&raquo; </p>
</div>
...
<div class="diagram-wrapper">
  <p><strong>سه جدال بنیادین درباره‌ی آزادی</strong></p>
...
```
  ...
  <figcaption>شکل ۳–۲: سه جدال بنیادین که هر بحث سیاسی درباره‌ی آزادی به یکی از آنها بازمی‌گردد</figcaption>
</div>

<div class="card accent-gold">
  <h4>&#128161; نتیجه‌ی تحلیلی</h4>
  <p> هر مکتب سیاسی بخشی از حقیقت آزادی را می‌بیند: <strong>راست</strong> اهمیت عدم مداخله و حریم خصوصی را می‌فهمد؛ <strong>چپ</strong> اهمیت شرایط مادی و ساختاری را؛ <strong>میانه</strong> تلاش می‌کند بین این دو توازن برقرار کند؛ و <strong>جمهوری‌خواهان</strong> به بُعد سلطه و قدرت توجه دارند که هم راست و هم چپ ممکن است نادیده بگیرند. همان‌طور که <strong>آمارتیا سن</strong> (1999) استدلال کرد: &laquo;آزادی‌های مختلف به یکدیگر وابسته‌اند&raquo;—آزادی سیاسی، اقتصادی، اجتماعی، و فرهنگی همه ضروری‌اند. </p>
</div>
