...
description: >-
  تحلیل تطبیقی دو سنت بزرگ فکری مدرن: چپ و راست، با تمرکز بر آرمان‌شهرها،
  دغدغه‌ها، نظریه‌پردازان و پیامدهای عملی
lang: fa
...
showInContents: true
categories:
  - ایدئولوژی‌های سیاسی، ایدئولوژی، گرایش سیاسی
coverImage: /images/articles/covers/راست-یا-چپ-در-این-میانه-کجاست-cover.webp
imageDisplay: full
cardImage: show
...
```mermaid
%%{init: { 'theme': 'base', 'themeVariables': { 'fontFamily': 'Vazirmatn' } } }%%
block-beta
    columns 8
...
<details>
<summary> نمودار به شکل دیگر</summary>
<div className="mermaid-wrapper" dir="rtl">
```mermaid
%%{init: { 'theme': 'base', 'themeVariables': { 'fontFamily': 'Vazirmatn' } } }%%
timeline
...
xychart-beta
    ...
    x-axis "سال" [1920, 1930, 1940, 1950, 1960, 1970, 1980, 1990, 2000, 2010, 2020]
...
<details>
<summary>مشاهده‌ی منابع </summary>
...
<details>
<summary>مشاهده‌ی فهرست </summary>
<div className="table-wrapper">
<table>
  <thead>
    <tr>
...
<details>
<summary>مشاهده‌ی نمایه </summary>
