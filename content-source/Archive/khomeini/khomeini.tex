...
\settextfont[Scale=1.05]{Parsi Matn}
...
\begin{tikzpicture}[remember picture, overlay]
  % پس‌زمینه بخش بالایی (سرمه‌ای تیره برای کنتراست عالی)
  \fill[cPrimary] (current page.north west) rectangle ([yshift=-12cm]current page.north east);
  
  % نوار طلایی جداکننده
  \fill[cGold] ([yshift=-12cm]current page.north west) rectangle ([yshift=-12.5cm]current page.north east);

  % عنوان کتاب (سفید روی سرمه‌ای - کنتراست بالا)
  \node[anchor=center] at ([yshift=-5cm]current page.north) {
    \begin{minipage}{\paperwidth}
      \centering
      \color{white}\fontsize{45}{55}\selectfont\bfseries
      \rl{وعده یا خدعه؟}
    \end{minipage}
  };
  
  \node[anchor=center] at ([yshift=-8cm]current page.north) {
    \begin{minipage}{0.8\paperwidth}
      \centering
      \color{white!90}\LARGE
      \rl{بررسی انتقادیِ وعدهٔ عدم نقش‌آفرینیِ سیاسیِ خمینی}
    \end{minipage}
  };

  % بخش پایینی روشن
  \fill[cLight] ([yshift=-12.5cm]current page.north west) rectangle (current page.south east);

  % قاب تصویر (حرفه‌ای و متمرکز)
  \node[anchor=center] at ([yshift=-1cm]current page.center) {
    \begin{tikzpicture}
      \draw[cGold, line width=3pt] (0,0) rectangle (9,11);
      \node[anchor=south west] at (0.2,0.2) {\includegraphics[height=10.6cm, width=8.6cm]{khomeini.png}};
    \end{tikzpicture}
  };

  % نام نویسنده (سرمه‌ای روی پس‌زمینه روشن - کنتراست بالا و جهت صحیح)
  \node[anchor=south] at ([yshift=2cm]current page.south) {
    \begin{minipage}{10cm}
      \centering
      \color{cPrimary}\large\bfseries
      \rl{نویسنده: مهدی سالم}
    \end{minipage}
  };
\end{tikzpicture}
\end{titlepage}
...
\begin{itemize}[label=\textcolor{cGold}{$\bullet$}, rightmargin=2em]
    \item \en{\textbf{Khomeinism: Essays on the Islamic Republic}} (۱۹۹۳): در این کتاب، آبراهامیان استدلال می‌کند که خمینیسم یک \keyword{پوپولیسم سیاسی} با پوششی مذهبی است. از نظر او، خمینی آگاهانه زبان و وعده‌های خود را متناسب با مخاطب تنظیم می‌کرد.\LTRfootnote{Ervand Abrahamian, Khomeinism: Essays on the Islamic Republic, Berkeley: University of California Press, 1993.}
    
    \item \en{\textbf{A History of Modern Iran}} (۲۰۰۸): در این اثر عمومی‌تر، آبراهامیان بر ابعاد \keyword{طبقاتی} و \keyword{ساختاری} انقلاب تأکید و نشان می‌دهد که خمینی چگونه با ائتلاف‌سازی میان طبقات مختلف، هژمونی خود را تثبیت کرد.\LTRfootnote{Ervand Abrahamian, A History of Modern Iran, Cambridge University Press, 2008.}
    
    \item \en{\textbf{Tortured Confessions}} (۱۹۹۹): مستند‌سازی سرکوب سیاسی در ایران پس از انقلاب، که نشان می‌دهد فاصلهٔ وعده‌های آزادی‌خواهانهٔ ۱۳۵۷ با واقعیت پس از آن چقدر عمیق بود.\LTRfootnote{Ervand Abrahamian, Tortured Confessions: Prisons and Public Recantations in Modern Iran, Berkeley: University of California Press, 1999.}
\end{itemize}
...
باخاش، تاریخ‌دان ایرانی-آمریکایی و استاد دانشگاه \en{George Mason}، در کتاب \en{\textbf{The Reign of the Ayatollahs}} (۱۹۸۴) یکی از نخستین روایت‌های آکادمیک جامع از تثبیت قدرت روحانیون را ارائه داد.\LTRfootnote{Shaul Bakhash, The Reign of the Ayatollahs: Iran and the Islamic Revolution, New York: Basic Books, 1984.}
...
ارجمند، جامعه‌شناس ایرانی-آمریکایی و استاد دانشگاه \en{Stony Brook}، در کتاب \en{\textbf{The Turban for the Crown}} (۱۹۸۸)\LTRfootnote{Said Amir Arjomand, The Turban for the Crown: The Islamic Revolution in Iran, Oxford University Press, 1988.} بر ابعاد \keyword{نهادی} انقلاب تمرکز دارد. او استدلال می‌کند که:
...
میلانی در \en{\textbf{The Making of Iran's Islamic Revolution}} (۱۹۸۸؛ ویراست دوم ۱۹۹۴)\LTRfootnote{Mohsen M. Milani, The Making of Iran's Islamic Revolution: From Monarchy to Islamic Republic, Boulder: Westview Press, 1988; 2nd ed. 1994.} رویکردی \keyword{ساختاری-عاملیتی} دارد. او نقش خمینی را نه صرفاً شخصی بلکه در چارچوب دینامیک‌های انقلابی و رقابت نخبگان تحلیل می‌کند و تا حدی به \keyword{تز چهارم} (فشار نخبگان) نزدیک‌تر است.
...
\begin{itemize}[label=\textcolor{cPrimary}{$\blacktriangleright$}, rightmargin=2em]
    ...
    هرچند کتاب است، شیرازی در فصول ۲ و ۳ تحلیل بسیار دقیقی از فرایند تدوین قانون اساسی ارائه می‌دهد و نشان می‌دهد \keyword{پیش‌نویس حبیبی} چگونه کنار گذاشته شد.\LTRfootnote{Asghar Schirazi, The Constitution of Iran, I.\,B.\,Tauris, 1997, pp.\,22--78.}
\end{itemize}
...
\foreach \x/\d/\t in {
    ...
    16/{خرداد ۱۳۶۰}/{عزل بنی‌صدر - تثبیت نهایی}
}{
    \ifodd\x
...
\begin{enumerate}[label=\textcolor{cGreen}{\bfseries شاهد \arabic*:}, rightmargin=2em]
    ...
    \item \textbf{عزیمت به قم:} خمینی پس از مدتی اقامت در تهران، در اسفند ۱۳۵۷ به قم رفت - مطابق وعده‌اش. هرچند بعداً مکرراً به تهران بازگشت و در نهایت بیمارستان قلب در جماران (شمال تهران) مقر دائمی‌اش شد.\LTRfootnote{Moin (1999), pp.\,210--212.}
...
\begin{itemize}[label=\textcolor{cGold}{$\bullet$}, rightmargin=2em]
    ...
    \item بنابراین وقتی خمینی می‌گفت «مقامی نخواهم داشت»، از نظر خودش دروغ نمی‌گفت - حتی وقتی ولی فقیه شد.\LTRfootnote{Moin (1999), pp.\,193--198.}
\end{itemize}
\end{noteBox}
...
این \keyword{چندزبانگی} (\en{code-switching}) نه اتفاقی بلکه \keyword{استراتژیک} بود.\LTRfootnote{Abrahamian (1993), pp.\,13--38.}
\end{principleBox}
...
\begin{itemize}[label=\textcolor{cAccent}{$\blacktriangleright$}, rightmargin=2em]
    ...
    \item \textbf{دادگاه‌های انقلاب:} صادق خلخالی به‌عنوان حاکم شرع قبل از هرگونه مبنای قانونی شروع به صدور حکم اعدام کرد - با اذن مستقیم خمینی.\LTRfootnote{Abrahamian (1999), pp.\,105--118.}
\end{itemize}
...
در این چارچوب، «خدعه» نه ضعف اخلاقی بلکه \keyword{ابزار جنگی مشروع} است.\LTRfootnote{Abrahamian (1993), pp.\,28--36.}
\end{principleBox}
...
\begin{itemize}[label=\textcolor{cGreen}{$\checkmark$}, rightmargin=2em]
    ...
    \item \textbf{مسئلهٔ «توطئه‌اندیشی»:} تز دوم نیازمند فرض یک \keyword{طراحی بلندمدت} است. آیا واقعاً منطقی است که کسی ده سال نقشه بکشد و هیچ خطایی نکند؟ واقعیت معمولاً آشفته‌تر از توطئه‌هاست.\LTRfootnote{This is the classical ``conspiracy theory'' critique. See Karl Popper, ``The Conspiracy Theory of Society'' in Conjectures and Refutations (1963).}
\end{itemize}
...
\begin{itemize}[label=\textcolor{cPrimary}{$\blacktriangleright$}, rightmargin=2em]
    \item \textbf{نقش فرانسه:} دولت فرانسه به خمینی در نوفل‌لوشاتو پناه داد و تصویر یک «رهبر معنوی معتدل» از او ساخت. خمینی این تصویر را به سود خود مدیریت کرد.\LTRfootnote{Charles Kurzman, The Unthinkable Revolution in Iran, Harvard University Press, 2004, pp.\,67--89.}
    ...
    \item \textbf{پیام به ارتش:} خمینی پیام‌های متعددی به نظامیان فرستاد و قول داد که ارتش حفظ خواهد شد. اما پس از انقلاب، پاکسازی گستردهٔ ارتش (اعدام ده‌ها ژنرال و افسر) نشان داد این وعده‌ها نیز تاکتیکی بودند.\LTRfootnote{Bakhash (1984), pp.\,56--72.}
\end{itemize}
...
\begin{itemize}[label=\textcolor{cPrimary}{$\blacktriangleright$}, rightmargin=2em]
    ...
    \item تبعید به ترکیه (۱۳۴۳) و سپس نجف (۱۳۴۳–۱۳۵۷) فرصت تأمل نظری به او داد.\LTRfootnote{Moin (1999), pp.\,86--120.}
\end{itemize}
...
مدافعان تز سوم (به‌ویژه ارجمند و مارتین) تأکید می‌کنند که حتی در «حکومت اسلامی»، نظریه هنوز \keyword{انتزاعی} و \keyword{آرمانی} بود. خمینی هیچ نقشهٔ عملی برای اجرای آن ارائه نداد - مثلاً دربارهٔ ساختار حکومت، نحوهٔ انتخاب فقیه، یا رابطهٔ ولی فقیه با مجلس سخنی نگفت.\LTRfootnote{Arjomand (1988), pp.\,147--155.}
...
\begin{itemize}[label=\textcolor{cGold}{$\blacktriangleright$}, rightmargin=2em]
    \item نظریهٔ ولایت فقیه در نجف یک «ایدهٔ خام» بود. تبدیل آن به یک \keyword{نهاد حقوقی} کار مجلس خبرگان (به‌ویژه بهشتی) بود، نه خود خمینی.\LTRfootnote{Arjomand (1988), pp.\,150--168.}
...
\begin{enumerate}[label=\textcolor{cGold}{\bfseries\arabic*.}, rightmargin=2em]
    ...
    \item این تغییر اصطلاحی بازتاب تغییر \keyword{مبنای فقهی} است: از فقه مشروطه‌محور نائینی به فقه حکومتی مستقل.\LTRfootnote{Martin (2000), pp.\,94--120.}
...
\begin{itemize}[label=\textcolor{cAccent}{$\times$}, rightmargin=2em]
    \item \textbf{«تکامل» یا «پنهان‌کاری»؟} آبراهامیان استدلال می‌کند که آنچه تز سوم «تکامل فکری» می‌نامد، ممکن است صرفاً \keyword{پنهان‌سازی تاکتیکی} باشد. خمینی در ۱۳۴۸ نظریه‌اش را نزد شاگردان حوزوی گفت (که مخاطبان محدودی بودند) و در ۱۳۵۷ آن‌را نزد رسانه‌های جهانی پنهان کرد.\LTRfootnote{Abrahamian (1993), pp.\,23--25.}
...
\begin{itemize}[label=\textcolor{cConsolid}{$\bullet$}, rightmargin=2em]
    \item \textbf{گائتانو موسکا} (\en{Gaetano Mosca}) و \textbf{ویلفردو پارتو} (\en{Vilfredo Pareto}): هر نظام سیاسی توسط «طبقهٔ حاکم» (نخبگان) اداره می‌شود. انقلاب‌ها نه حذف نخبگان بلکه \keyword{جایگزینی} یک طبقهٔ نخبه با طبقه‌ای دیگر هستند.\LTRfootnote{Vilfredo Pareto, The Rise and Fall of the Elites (1901); Gaetano Mosca, The Ruling Class (1939).}
    
    \item \textbf{رابرت میشلز} (\en{Robert Michels}): «قانون آهنین الیگارشی» - هر سازمان، هرچقدر هم دموکراتیک شروع کند، به‌سمت تمرکز قدرت در دست عدهٔ کمی حرکت می‌کند.\LTRfootnote{Robert Michels, Political Parties: A Sociological Study of the Oligarchical Tendencies of Modern Democracy (1911).}
    
    \item \textbf{تدا اسکاچپول} (\en{Theda Skocpol}): انقلاب‌ها محصول فروپاشی ساختار دولت هستند، نه لزوماً طراحی یک فرد. \keyword{خلأ قدرت} فضا را برای رقابت نخبگان باز می‌کند.\LTRfootnote{Theda Skocpol, States and Social Revolutions (1979).}
\end{itemize}
...
\begin{itemize}[label=\textcolor{cConsolid}{$\blacktriangleright$}, rightmargin=2em]
    ...
    \item \textbf{تشدید تنش با کردستان:} حزب جمهوری اسلامی و سپاه پاسداران در مناطق کردنشین سیاست تهاجمی‌تری از آنچه دولت موقت می‌خواست پیش گرفتند - و این تنش به بهانه‌ای برای تقویت نهادهای انقلابی (سپاه) در برابر نهادهای رسمی (ارتش و دولت) تبدیل شد.\LTRfootnote{Bakhash (1984), pp.\,108--122.}
...
این مشابه آن چیزی است که در نظریهٔ بازی‌ها \en{commitment device} نامیده می‌شود: اقدامی که بازیگر را به مسیر خاصی متعهد می‌کند و بازگشت را غیرممکن می‌سازد.\LTRfootnote{Thomas Schelling, The Strategy of Conflict (1960), pp.\,22--28.}
\end{noteBox}
...
\begin{enumerate}[label=\textcolor{cPrimary}{\bfseries\arabic*.}, rightmargin=2em]
    ...
    \item \textbf{استراتژی‌های حذف:} حلقهٔ درونی با بهره‌گیری از این منابع، رقبا را یکی‌یکی حذف کرد - اما خمینی خودش لزوماً «طراح» هر حذف نبود. بیشتر «تأییدکنندهٔ نهایی» بود.\LTRfootnote{Milani (1994), pp.\,141--180.}
\end{enumerate}
\end{principleBox}
...
\begin{itemize}[label=\textcolor{cConsolid}{$\blacktriangleright$}, rightmargin=2em]
    ...
    \item این الگو ممکن بود ناشی از «فریبکاری» باشد (تز دوم) یا از «وفاداری به پایگاه اجتماعی» (تز چهارم) - باخاش صراحتاً انتخاب نمی‌کند.\LTRfootnote{Bakhash (1984), pp.\,50--110.}
\end{itemize}
...
\begin{itemize}[label=\textcolor{cAccent}{$\times$}, rightmargin=2em]
    ...
    \item \textbf{مسئلهٔ «وتوی نهایی»:} حتی اگر بهشتی «طراح» بود، خمینی قدرت وتو داشت. اینکه هیچ‌گاه وتو نکرد، خود نشانهٔ \keyword{موافقت فعال} است.\LTRfootnote{Abrahamian (1993), pp.\,33--35.}
...
\begin{enumerate}[label=\textcolor{cGold}{\bfseries\arabic*.}, rightmargin=2em]
    ...
    \item \textbf{تأثیر نمادین:} حضور خمینی در «پایتخت روشنگری» به روایت «رهبر معنوی معتدل» اعتبار می‌داد.\LTRfootnote{Kurzman (2004), pp.\,67--75.}
\end{enumerate}
\end{noteBox}
...
\begin{enumerate}[label=\textcolor{cAccent}{\bfseries\arabic*.}, rightmargin=2em]
    \item \textbf{مقایسهٔ متون:} در برخی موارد، متن فارسی مصاحبه‌ها «تندتر» از ترجمهٔ انگلیسی/فرانسوی آن‌هاست. مثلاً وقتی خمینی به فارسی از «حکومت اسلامی» سخن می‌گوید، یزدی آن‌را \en{``Islamic Republic''} ترجمه می‌کند - واژه‌ای که بار معنایی ملایم‌تری دارد.\LTRfootnote{Moin (1999), pp.\,187--188.}
...
\foreach \x/\d/\t in {
    ...
    3/{۲۱ مهر ۵۷}/{نخستین مصاحبهٔ رسمی با \en{Le Monde}},
    6/{۱۰ آبان ۵۷}/{تشکیل شورای انقلاب (مخفی)},
    8/{۲۵ آبان ۵۷}/{مصاحبه با \en{Fallaci}},
    11/{۱۵ آذر ۵۷}/{عاشورای ۵۷ - تظاهرات میلیونی در تهران},
    13/{۲ دی ۵۷}/{پیام «ارتشیان به خانه‌ها بروید»},
    16/{۱۶ دی ۵۷}/{خروج شاه از ایران},
    18/{۱۲ بهمن ۵۷}/{بازگشت خمینی به ایران}
}{
    \ifodd\x
...
\caption{فضای مطبوعاتی روزهای منتهی به سقوط دولت بختیار (۱۳۵۷)}
\end{figure}
...
مدافعان تز دوم به عبارت «حق شرعی» توجه می‌کنند: خمینی اول به «حق شرعی» (= ولایت فقیه) و بعد به «آرای مردم» استناد کرد. ترتیب مهم است: \keyword{شرع مقدم بر مردم} بود - حتی در همان لحظهٔ اول. مدافعان تز اول پاسخ می‌دهند: این فقط فرمول فقهی معمول بود و نباید بیش از حد تفسیر شود.\LTRfootnote{Martin (2000), pp.\,152--158.}
\end{warningBox}
...
\begin{itemize}[label=\textcolor{cAccent}{$\blacktriangleright$}, rightmargin=2em]
    \item کودتای نافرجام نوژه (تیر ۱۳۵۹) - که گفته شد بختیار در آن نقش داشت - به بهانه‌ای برای پاکسازی گسترده‌تر ارتش تبدیل شد.\LTRfootnote{Abrahamian (1999), pp.\,118--122.}
...
\begin{enumerate}[label=\textcolor{cAccent}{\bfseries\arabic*.}, rightmargin=2em]
    ...
    \begin{itemize}
        ...
        \item میزان مشارکت نسبتاً پایین بود (حدود ۵۱٪).\LTRfootnote{Arjomand (1988), pp.\,155--158.}
    \end{itemize}
...
\begin{enumerate}[label=\textcolor{cPrimary}{\bfseries\arabic*.}, rightmargin=2em]
    ...
    \item \textbf{سرکوب مخالفان:} هم‌زمان با مذاکرات مجلس خبرگان، حملات فیزیکی به دفاتر احزاب مخالف (حزب دموکرات کردستان، سازمان چریک‌های فدایی، حزب خلق مسلمان شریعتمداری) تشدید شد - که فضای ارعاب ایجاد کرد.\LTRfootnote{Abrahamian (1999), pp.\,130--135.}
\end{enumerate}
...
\begin{itemize}[label=\textcolor{cAccent}{$\blacktriangleright$}, rightmargin=2em]
    \item \textbf{هدایت‌الله متین‌دفتری} (نوهٔ مصدق، رهبر جبههٔ دموکراتیک ملی): ولایت فقیه را «بازگشت به استبداد» خواند.\LTRfootnote{Bakhash (1984), p.\,80.}
    ...
    \item \textbf{دکتر هما کاتوزیان}: «پیش‌نویسی که ما نوشتیم، بازتاب وعده‌هایی بود که خمینی در پاریس داد. آنچه تصویب شد، نقض آن وعده‌هاست.»\LTRfootnote{Katouzian, ``The Short-Lived Hopes,'' various conference papers.}
\end{itemize}
...
\draw[line] (0,0) -- (13.5,0);

\node[event=cGreen, above=0.7cm] (e1) at (0,0)
{\rl{پیش‌نویس حبیبی–کاتوزیان\\منتشر می‌شود}};
\draw[-{Stealth[length=2.5pt]}, cGreen!50] (0,0) -- (e1);
\node[date] at (0,0.25) {\rl{۲۶ خرداد ۵۸}};
\fill[cGreen] (0,0) circle (2.5pt);

\node[event=cGold, below=0.7cm] (e2) at (2.8,0)
{\rl{خمینی: «خوب است»\\پیشنهاد رفراندوم}};
\draw[-{Stealth[length=2.5pt]}, cGold!50] (2.8,0) -- (e2);
\node[date] at (2.8,0.25) {\rl{تیر ۵۸}};
\fill[cGold] (2.8,0) circle (2.5pt);

\node[event=cWarn, above=0.7cm] (e3) at (5.2,0)
{\rl{حزب جمهوری اسلامی:\\«مجلس خبرگان لازم است»}};
\draw[-{Stealth[length=2.5pt]}, cWarn!50] (5.2,0) -- (e3);
\node[date] at (5.2,0.25) {\rl{تیر–مرداد ۵۸}};
\fill[cWarn] (5.2,0) circle (2.5pt);

\node[event=cAccent, below=0.7cm] (e4) at (7.6,0)
{\rl{انتخابات مجلس خبرگان\\پیروزی روحانیون (۷۵٪)}}; 
\draw[-{Stealth[length=2.5pt]}, cAccent!50] (7.6,0) -- (e4);
\node[date] at (7.6,0.25) {\rl{۱۲ مرداد ۵۸}};
\fill[cAccent] (7.6,0) circle (2.5pt);

\node[event=cPrimary, above=0.7cm] (e5) at (10,0)
{\rl{مذاکرات مجلس خبرگان\\تصویب ولایت فقیه}};
\draw[-{Stealth[length=2.5pt]}, cPrimary!50] (10,0) -- (e5);
\node[date] at (10,0.25) {\rl{مرداد–آبان ۵۸}};
\fill[cPrimary] (10,0) circle (2.5pt);

\node[event=cAccent, below=0.7cm] (e6) at (12.8,0)
{\rl{رفراندوم قانون اساسی\\۹۹٫۵٪ آری}};
\draw[-{Stealth[length=2.5pt]}, cAccent!50] (12.8,0) -- (e6);
\node[date] at (12.8,0.25) {\rl{۱۲ آذر ۵۸}};
\fill[cAccent] (12.8,0) circle (2.5pt);

\end{tikzpicture}
}
\caption{\rl{گاه‌شمار: از پیش‌نویس تا تصویب قانون اساسی (خرداد–آذر ۱۳۵۸)}}
...
ترور آیت‌الله مرتضی مطهری در شب ۱۲ اردیبهشت ۱۳۵۸ (یک روز پس از روز معلم) مهم‌ترین ترور فرقان بود. مطهری از نزدیک‌ترین شاگردان خمینی، عضو شورای انقلاب، و یکی از محبوب‌ترین روحانیون-روشنفکر بود.\LTRfootnote{Moin (1999), pp.\,214--216.}
...
\begin{enumerate}[label=\textcolor{cPrimary}{\bfseries\arabic*.}, rightmargin=2em]
    \item \textbf{تقویت سپاه پاسداران:} سپاه اعلام کرد فقط او توانایی مقابله با «ضدانقلاب» را دارد. بودجه و نیروی سپاه افزایش یافت.\LTRfootnote{Bakhash (1984), pp.\,63--65.}
    
    \item \textbf{تقویت دادگاه‌های انقلاب:} خلخالی از ترورها به‌عنوان توجیه سرعت‌بخشی به محاکمات استفاده کرد.
    
    \item \textbf{محدودسازی مطبوعات:} روزنامه‌هایی که از «آزادی گروه‌ها» دفاع می‌کردند، تحت فشار قرار گرفتند. روزنامهٔ \textit{آیندگان} در مرداد ۱۳۵۸ توقیف شد.\LTRfootnote{Abrahamian (1999), pp.\,132--135.}
...
\node[box] (a) at (0,0) \rl{{ترور\\(فرقان، ضدانقلاب)}};
\node[box] (b) at (5,0) \rl{{واکنش امنیتی\\(سرکوب، خلع سلاح)}};
\node[box] (c) at (5,-3) \rl{{محدودیت آزادی‌ها\\(مطبوعات، احزاب)}};
\node[box] (d) at (0,-3) \rl{{نارضایتی مخالفان\\خشونت بیشتر}};
...
\node[font=\large\bfseries, text=cAccent] at (2.5,-1.5) \rl{{چرخهٔ\\سرکوب-مقاومت}};
...
\begin{itemize}[label=\textcolor{cConsolid}{$\blacktriangleright$}, rightmargin=2em]
    ...
    \item اعترافات تلویزیونی اعضای فرقان قبل از اعدام، الگوی کلیشه‌ای «اعترافات اجباری» داشت.\LTRfootnote{Abrahamian (1999), pp.\,140--145.}
...
\begin{enumerate}[label=\textcolor{cPrimary}{\bfseries\arabic*.}, rightmargin=2em]
    \item \textbf{کودتای ۲۸ مرداد ۱۳۳۲:} سازمان \en{CIA} و \en{MI6} دولت ملی مصدق را سرنگون کردند و شاه را بازگرداندند. این کودتا \keyword{زخم تاریخی} عمیقی بر جای گذاشت.\LTRfootnote{Ervand Abrahamian, The Coup: 1953, the CIA, and the Roots of Modern U.S.-Iranian Relations, New York: The New Press, 2013.}
    
    \item \textbf{حمایت آمریکا از شاه:} آمریکا طی ۲۵ سال حامی اصلی رژیم پهلوی بود - از فروش سلاح تا آموزش ساواک.
    
    \item \textbf{پذیرش شاه در آمریکا (مهر ۱۳۵۸):} ورود محمدرضا شاه به نیویورک برای «درمان» سرطان، موجی از خشم عمومی در ایران ایجاد کرد. بسیاری ایرانیان ترسیدند که سناریوی ۱۳۳۲ تکرار شود: آمریکا شاه را بازگرداند.\LTRfootnote{Mark Bowden, Guests of the Ayatollah (2006), pp.\,3--15.}
\end{enumerate}
...
\begin{itemize}[label=\textcolor{cAccent}{$\blacktriangleright$}, rightmargin=2em]
    ...
    \item ملاقات بازرگان و وزیر خارجه‌اش (یزدی) با برژینسکی (مشاور امنیت ملی آمریکا) در الجزایر (آبان ۱۳۵۸) شک‌ها را تقویت کرد.\LTRfootnote{Bowden (2006), pp.\,16--25.}
\end{itemize}
...
گروهی از دانشجویان دانشگاه‌های تهران - که خود را «دانشجویان مسلمان پیرو خط امام» نامیدند - در صبح ۱۳ آبان ۱۳۵۸ از دیوارهای سفارت بالا رفتند و آن‌را اشغال کردند. ۵۲ دیپلمات و کارمند آمریکایی گروگان گرفته شدند.\LTRfootnote{Bowden (2006), pp.\,30--60.}
...
\begin{itemize}[label=\textcolor{cAccent}{$\times$}]
    \item حجت‌الاسلام موسوی‌خوئینی‌ها - عضو حزب جمهوری اسلامی و روحانی ناظر بر دانشجویان - نقش هماهنگ‌کننده داشت.\LTRfootnote{Bakhash (1984), pp.\,134--140.}
...
\begin{itemize}[label=\textcolor{cAccent}{$\blacktriangleright$}, rightmargin=2em]
    ...
    \item نتیجهٔ رفراندوم: ۹۹.۵٪ آری - عددی که بیشتر نشانهٔ \keyword{فقدان آزادی رأی} است تا اجماع واقعی.\LTRfootnote{Schirazi (1997), pp.\,36--40.}
\end{itemize}
...
\foreach \x/\d/\t in {
    ...
    3/{۱۵ آبان ۵۸}/{استعفای بازرگان},
    6/{۱۲ آذر ۵۸}/{رفراندوم قانون اساسی\\۹۹.۵٪ آری},
    8/{۵ بهمن ۵۸}/{انتخاب بنی‌صدر\\به ریاست‌جمهوری},
    11/{فروردین ۵۹}/{شکست عملیات طبس},
    13/{مهر ۵۹}/{آغاز جنگ عراق\\پیچیده‌شدن بحران},
    16/{۳۰ دی ۵۹}/{آزادی گروگان‌ها\\(توافق الجزایر)}
}{
    \ifodd\x
        \node[event, above=0.7cm] (e\x) at (\x,0) {\t};
        \draw[-{Stealth[length=2.5pt]}, cPrimary!50] (\x,0) -- (e\x);
...
\begin{itemize}[label=\textcolor{cPrimary}{$\blacktriangleright$}, rightmargin=2em]
    ...
    \item رئیس‌جمهور (ابتدا بنی‌صدر، سپس خامنه‌ای) در عمل فرماندهی واقعی نداشت.\LTRfootnote{Crist (2012), pp.\,100--130.}
\end{itemize}
...
ابوالحسن بنی‌صدر در ۵ بهمن ۱۳۵۸ با حدود ۷۶٪ آرا به ریاست‌جمهوری انتخاب شد - بالاترین درصد رأی در تاریخ انتخابات ایران.\LTRfootnote{Bakhash (1984), pp.\,130--135.} بنی‌صدر:
...
\begin{itemize}[label=\textcolor{cPrimary}{$\blacktriangleright$}, rightmargin=2em]
    ...
    \item مجاهدین در انتخابات مجلس (۱۳۵۹) شرکت کردند اما عملاً از نتایج حذف شدند.\LTRfootnote{Abrahamian, Radical Islam (1989), pp.\,170--220.}
...
کردند و موج عملیات مسلحانه آغاز شد.\LTRfootnote{Abrahamian, Radical Islam (1989), pp.\,218--230.} تاریخ ۳۰ خرداد ۱۳۶۰ در تقویم جمهوری اسلامی به‌عنوان «سالروز شکست فتنهٔ منافقین» و در تقویم مجاهدین به‌عنوان «آغاز مقاومت» ثبت شده است.
...
\begin{itemize}[label=\textcolor{cAccent}{$\blacktriangleright$}, rightmargin=2em]
    ...
    \item بسیاری از اعدام‌شدگان نوجوان (زیر ۱۸ سال) بودند.\LTRfootnote{Amnesty International, ``Iran: Violations of Human Rights,'' 1982.}
...
\begin{itemize}[label=\textcolor{cGold}{$\bullet$}, rightmargin=2em]
    ...
    \item مجاهدین بعدها به عراق رفتند و در کنار صدام علیه ایران جنگیدند (عملیات فروغ جاویدان / مرصاد، ۱۳۶۷) - عملی که اعتبارشان را حتی نزد بسیاری از مخالفان نظام از بین برد.\LTRfootnote{Abrahamian, Radical Islam (1989), pp.\,245--260.}
\end{itemize}
\end{noteBox}
...
\begin{enumerate}[label=\textcolor{cGold}{\bfseries\arabic*.}, rightmargin=2em]
    ...
    \item باعث شد پس از مرگ خمینی (خرداد ۱۳۶۸)، علی خامنه‌ای - که نه مرجع تقلید بود و نه سابقهٔ فقهی کافی داشت - ولی فقیه شود. یعنی عزل منتظری \keyword{مسیر تاریخ ایران را تغییر داد}.\LTRfootnote{Moin (1999), pp.\,280--295.}
\end{enumerate}
\end{noteBox}
...
ر.ک.\ \en{Edward Tufte},
\textit{\en{The Visual Display of Quantitative Information}}, 2nd ed., 2001, p.\,178.}

\begin{figure}[ht]
\centering
\begin{tikzpicture}[scale=1.1]
  % axes
  \foreach \ang in {90, 38.57, 347.14, 295.71, 244.28, 192.85, 141.42} {
    \draw[cGray!40] (0,0) -- (\ang:3.8);
  }
  % grid (r=1.1, 2.2, 3.3)
  \foreach \r in {1.1, 2.2, 3.3} {
    \draw[cGray!20, thin] (90:\r) -- (38.57:\r) -- (347.14:\r) -- (295.71:\r) -- (244.28:\r) -- (192.85:\r) -- (141.42:\r) -- cycle;
  }
  % labels
  \node[font=\tiny] at (90:4.1) {پاریس};
  \node[font=\tiny] at (38.57:4.1) {بختیار};
  \node[font=\tiny] at (347.14:4.1) {خبرگان};
  \node[font=\tiny] at (295.71:4.1) {فرقان};
  \node[font=\tiny] at (244.28:4.1) {گروگان‌گیری};
  \node[font=\tiny] at (192.85:4.1) {جنگ};
  \node[font=\tiny] at (141.42:4.1) {تصفیه/۶۷};

  % --- plot polygons (direct draw) ----------------------
  % T1
  \draw[cGreen, thick, fill=cGreen, fill opacity=0.12] 
    (90:3.3) -- (38.57:1.1) -- (347.14:1.1) -- (295.71:2.2) -- (244.28:1.1) -- (192.85:1.1) -- (141.42:1.1) -- cycle;
  % T2
  \draw[cAccent, thick, fill=cAccent, fill opacity=0.12] 
    (90:3.3) -- (38.57:3.3) -- (347.14:3.3) -- (295.71:2.2) -- (244.28:3.3) -- (192.85:2.2) -- (141.42:3.3) -- cycle;
  % T3
  \draw[cGold, thick, fill=cGold, fill opacity=0.12] 
    (90:2.2) -- (38.57:2.2) -- (347.14:3.3) -- (295.71:2.2) -- (244.28:2.2) -- (192.85:3.3) -- (141.42:2.2) -- cycle;
  % T4
  \draw[cConsolid, thick, fill=cConsolid, fill opacity=0.12] 
    (90:2.2) -- (38.57:2.2) -- (347.14:2.2) -- (295.71:3.3) -- (244.28:3.3) -- (192.85:3.3) -- (141.42:3.3) -- cycle;

  % --- simple legend ------------------------------------
  \begin{scope}[shift={(4.5,2.5)}]
    \draw[cGray!20, fill=white] (-0.2,-1.8) rectangle (1.8,0.2);
    \fill[cGreen!30] (0,0) rectangle (0.3,-0.3) node[right, black, font=\tiny] { \rl{تز ۱} };
    \fill[cAccent!30] (0,-0.4) rectangle (0.3,-0.7) node[right, black, font=\tiny] { \rl{تز ۲} };
    \fill[cGold!30] (0,-0.8) rectangle (0.3,-1.1) node[right, black, font=\tiny] { \rl{تز ۳} };
    \fill[cConsolid!30] (0,-1.2) rectangle (0.3,-1.5) node[right, black, font=\tiny] { \rl{تز ۴} };
  \end{scope}
\end{tikzpicture}
...
\textbf{ت‌۱:\ صداقت\newline + اضطرار}
  ...
  & \begin{itemize}[nosep, leftmargin=*]
    ...
    \item نمی‌تواند فتوای ۱۳۶۷ را توجیه کند%
      \LTRfootnote{\en{Robertson}, \textit{\en{Massacre}}, 2010, p.\,122.}
    \end{itemize} \\
\addlinespace
...
\textbf{ت‌۲:\ فریب\newline آگاهانه}
  & \begin{itemize}[nosep, leftmargin=*]
    ...
    \item با آموزهٔ تقیه قابل ارتباط%
      \LTRfootnote{\en{Moin}, \textit{\en{Khomeini}}, 1999, pp.\,200–204.}
...
\textbf{ت‌۳:\ تطور\newline ایدئولوژیک}
  ...
  & \begin{itemize}[nosep, leftmargin=*]
    ...
    \item انطباق با واقعیت در بزنگاه‌های میانی.
    \end{itemize} \\
\addlinespace
...
\LTRfootnote{\en{Moin}, \textit{\en{Khomeini}}, 1999, pp.\,8–11.}
...
مجلس خبرگان / قانون اساسی
  ...
  & بزنگاه نهادینه‌سازیِ ولایت فقیه؛
    ...
    \LTRfootnote{\en{Schirazi}, 1997, pp.\,22–48.} \\
\addlinespace
...
بحران گروگان‌گیری
  ...
  & ابزارسازی آگاهانه از بحران؛
    ...
    \LTRfootnote{\en{Bowden}, 2006, pp.\,204–219.} \\
\addlinespace
...
جنگ ایران و عراق
  ...
  & تبدیل جنگ به ابزار بسیج و مشروعیت‌سازی؛
    ...
    \LTRfootnote{\en{Crist}, 2012, pp.\,88–103.} \\
\addlinespace
...
۱۳۶۷ (تیر)
  ...
  & پذیرش قطعنامهٔ ۵۹۸ - «نوشیدن جام زهر»%
    \LTRfootnote{\en{Crist}, 2012, pp.\,350–362.}
  & \cellcolor{cGold!15}ت‌۳ \\
\addlinespace
...
۱۳۶۸ (۱۴ خرداد)
  & ۱۹۸۹ (۳ ژوئن)
  & درگذشت خمینی%
    \LTRfootnote{\en{Moin}, 1999, pp.\,305–312.}
  & - \\
...
\textcolor{cGray}{قلم فارسی:} & \en{Parsi Matn} \\
...
\begin{tikzpicture}
  ...
  \node[font=\small, text=cPrimary, align=center] at (0,0.4)
    {\rl{و باشد که از وفای به عهد کنندگان باشید!}};  
\end{tikzpicture}
