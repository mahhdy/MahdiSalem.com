...
description: بازنویسی، تکمیل و تدقیق شده‌ی کامنت من ذیل پست دکتر قاضیان عزیز... حق دعوت از بیگانگان یا معقولیت آن در این برهه؟
lang: fa
...
در پاسخ و‌ پی‌نوشت به: https://www.facebook.com/share/v/14SCjutibVS/?mibextid=wwXIfr

بازنویسی، تکمیل و تدقیق شده‌ی کامنت من ذیل پست دکتر قاضیان عزیز... 
...
1. **قاعده‌ی کمّیت (Maxim of Quantity):** سهم خود را به اندازه‌ی لازم — نه بیشتر و نه کمتر — ارائه کن.
...
فرض کنید سه نوع شیرینی در برابر شماست و شما می‌گویید: **«این شیرینی [اولی] خیلی خوشمزه است.»**
...
## ۳. تطبیق سیاسی: گفتمان مداخله‌ی خارجی و بی‌طرفی کاذب
...
1. **کنش بیانی (Locutionary Act):** ادای الفاظ و تولید جمله.
...
## ۴. مخاطرات استراتژیک: از بازتعریف وطن تا لغزش به سوی تجزیه‌طلبی
...
1. **هیچ گفتار سیاسی‌ای مطلقاً خنثی نیست.** در شرایط قطبی‌شده و ملتهب، حتی «طرح یک امکان» نیز واجد بار معنایی و جهت‌دهی مشخصی است.

2. **تأکید انحصاری بر بار منطقی و نادیده‌گرفتن بار معنایی، یا خطای تحلیلی‌ست یا ترفند بلاغی.** این رویکرد، فرار از مسئولیت اجتماعی گوینده و نوعی خنثی‌نمایی کاذب (False Neutrality) است.

3. **انتخاب مثال، خود یک کنش جهت‌دار است.** مثال‌هایی که برای تبیین یک اصل انتخاب می‌شوند، بار معنایی مستقلی دارند و می‌توانند پیام اصلی را تقویت یا تضعیف کنند.

4. **بازتعریف سیّال مفاهیم هویتی، ریسک‌های غیرقابل مدیریت دارد.** اگر «وطن‌دوستی» و «حاکمیت ملی» به‌سادگی بازتعریف شوند تا مداخله‌ی خارجی را توجیه کنند، همین منطق می‌تواند مبنای تجزیه‌طلبی قرار گیرد.

5. **مسئولیت سخنگو محدود به نیت او نیست.** بر اساس نظریه‌ی کنش گفتاری، اثر واقعی سخن بر مخاطب و جامعه (کنش پرلاکوشنری) بخشی از مسئولیت گوینده است.

> **تذکر پایانی:** حفظ انسجام ملی و تمامیت ارضی ایجاب می‌کند که در نقد استبداد داخلی — هرچند موجّه و ضروری — به دامان گفتمان‌ها و مفاهیمی که راه را بر گسست‌های هویتی و سرزمینی می‌گشایند، درنغلتیم. روشنفکری مسئولانه نه در ساده‌سازی، بلکه در پذیرش پیچیدگی و تحمل دشواری تحلیل چندوجهی نهفته است.
...
### اصول فقه و منطق اسلامی (مرتبط با قاعده‌ی مذکور در متن)
