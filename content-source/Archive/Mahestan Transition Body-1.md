...
**بند ۱۱.** در صورت عدم تشکیل هیچ ائتلافی، برای پست ریاست کابینه رأی‌گیری صورت گرفته و فردی که بالاترین رأی را بیاورد مسئول تشکیل کابینه خواهد شد. در صورتی که کابینه نتواند ظرف یک هفته تشکیل شده یا رأی اعتماد بگیرد، افراد معرفی‌شده با بیشترین رأی به‌عنوان اعضای منتخب کابینه معرفی خواهند شد.
...
flowchart TD
    ...
    ━━━━━━━━
    - ثبت طومارهای مردمی
    - اگر طوماری ۱۰۰,۰۰۰+ امضا جمع کرد:
...
flowchart TD
    ...
    - لایحه: از سوی کابینه
    - درخواست مردمی: طومار ۱۰۰,۰۰۰+ امضا"]
...
- هر موضوعی که ۵۰۰,۰۰۰+ امضای مردمی برای رفراندوم جمع‌آوری شود
...
**بند ۳۰.** در صورت عدم رضایت مردم یک منطقه از نماینده‌ی خود، در صورت جمع‌آوری **۴۰٪ آرای مأخوذه** برای درخواست عزل، نماینده عزل و فرد بعدی در فهرست جایگزین خواهد شد.

**بند ۳۱.** در صورت فوت یا عدم توانایی مشارکت هر نماینده، فرد بعدی در فهرست از همان ناحیه جایگزین خواهد شد.

**بند ۳۲.** این مجلس **نمی‌تواند بیش از دو سال** ادامه داشته باشد و باید ۲ ماه قبل از اتمام دو سال، رأی‌گیری مجددی صورت گیرد.
...
```mermaid
gantt
    title خط زمانی گذار ایران — طرح مهستان
    dateFormat  YYYY-MM-DD
    axisFormat %b %Y

    section فاز صفر — آمادگی از هم‌اکنون
    جریان‌ها قانون اساسی موقت خود را می‌نویسند :a0, 2025-01-01, 180d
    فهرست‌ها و ائتلاف‌ها شکل می‌گیرد           :a1, 2025-01-01, 180d
    زیرساخت فنی رأی‌گیری طراحی می‌شود         :a2, 2025-01-01, 150d
    منشور اصول بنیادین تدوین می‌شود            :a3, 2025-02-01, 90d

    section فاز ۱ — آغاز گذار و انتخابات
    آغاز رسمی دوره‌ی گذار                     :milestone, m1, 2025-07-01, 0d
    ثبت‌نام و تبلیغات رسمی                     :b1, 2025-07-01, 21d
    انتخابات مجلس مهستان                      :crit, b2, 2025-07-22, 3d
    تشکیل مجلس مهستان                        :milestone, m2, 2025-08-01, 0d

    section فاز ۲ — فرمان‌ها و اقدامات فوری
    فرمان‌های اضطراری (۱۰ فرمان)                :crit, c1, 2025-08-01, 7d
    تشکیل کابینه و رأی اعتماد                  :c2, 2025-08-01, 21d
    مصوبات فوری (قوانین اولویت بالا)            :c3, 2025-08-08, 28d

    section فاز ۳ — قانون اساسی موقت
    کمیسیون ویژه و جمع‌آوری پیش‌نویس‌ها          :d1, 2025-08-01, 14d
    تدوین متن واحد                             :crit, d2, 2025-08-15, 28d
    بازخوردگیری عمومی                          :d3, 2025-09-12, 14d
    رأی‌گیری در مجلس (⅔)                       :d4, 2025-09-26, 5d
    رفراندوم قانون اساسی موقت                   :crit, d5, 2025-10-01, 14d
    اجرای قانون اساسی موقت                     :milestone, m3, 2025-10-15, 0d

    section فاز ۴ — نهادسازی و اصلاحات
    شورای قضایی انتقالی                        :e1, 2025-10-15, 30d
    کمیسیون حقیقت‌یابی                         :e2, 2025-10-15, 45d
    قانون عدالت انتقالی                        :e3, 2025-10-15, 60d
    اصلاح بخش امنیتی (SSR)                     :e4, 2025-10-15, 180d
    شورای اقتصادی + اصلاحات                    :e5, 2025-10-15, 180d
    واحد ارتباط مردمی و دموکراسی مستقیم        :e6, 2025-08-01, 60d
    بستر دیجیتال نظرسنجی                       :e7, 2025-09-01, 90d

    section فاز ۵ — قانون اساسی نهایی
    مجلس مؤسسان یا کمیسیون ویژه                :f1, 2026-01-01, 30d
    تدوین پیش‌نویس                              :crit, f2, 2026-02-01, 180d
    مشاوره‌ی عمومی گسترده                       :f3, 2026-04-01, 150d
    نهایی‌سازی                                  :f4, 2026-09-01, 45d
    رفراندوم قانون اساسی نهایی                  :crit, f5, 2026-10-15, 14d

    section فاز ۶ — انتقال قدرت
    انتخابات بر اساس قانون اساسی نهایی          :crit, g1, 2027-01-01, 30d
    انتقال رسمی قدرت                            :milestone, m4, 2027-03-01, 0d
    پایان رسمی دوره‌ی گذار                      :milestone, m5, 2027-07-01, 0d
```
...
*این سند زنده است و به‌روزرسانی خواهد شد. آخرین ویرایش: ۲۰۲۵*
