...
<div class="mermaid-wrapper">
<pre class="mermaid">%%{init:{'theme':'base','themeVariables':{'primaryColor':'#0F3460','secondaryColor':'#E94560'}}}%%
...
<div class="mermaid-wrapper">
<pre class="mermaid">pie title "سهم تقریبی هر سنت فکری در شکل‌گیری حقوق بشر مدرن"
